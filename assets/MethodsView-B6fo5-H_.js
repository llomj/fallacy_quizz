import{j as e}from"./react-vendor-vrmkM06s.js";import{u as a}from"./index-D683ZQMo.js";import{h as n,o}from"./syntax-highlighter-CMWetiVG.js";import"./questions-data-CC6m8dd1.js";import"./detailed-explanations-UOj9Nfp2.js";import"./short-explanations-BS-RsdIe.js";const c=`# ----------------- Navigation -----------------
...
watch -n 1 cmd         # Run cmd every 1 sec`,l=`# ----------------- Navigation -----------------
...
watch -n 1 cmd         # Exécuter cmd chaque 1 sec`,g=({onBack:i,onPlayClickSound:r})=>{const{language:t}=a(),s=t==="fr"?l:c;return e.jsxs("div",{className:"relative min-h-[600px] animate-in slide-in-from-left duration-500 pb-12",children:[e.jsxs("div",{className:"flex items-center justify-between mb-8",children:[e.jsxs("h2",{className:"text-2xl font-black text-white flex items-center gap-3",children:[e.jsx("i",{className:"fas fa-code text-yellow-300"}),t==="fr"?"Référence des commandes":"Command Reference"]}),e.jsx("button",{onClick:()=>{r==null||r(),i()},className:"px-4 py-2 bg-white/5 hover:bg-white/10 rounded-xl text-sm font-bold transition-colors",children:t==="fr"?"Retour":"Back"})]}),e.jsx("div",{className:"glass rounded-2xl p-6 border border-white/5 overflow-x-auto",children:e.jsx(n,{language:"bash",style:o,customStyle:{padding:"1rem",margin:0,borderRadius:"0.75rem",background:"transparent",fontSize:"0.8rem",lineHeight:"1.6",fontFamily:"'Fira Code', monospace"},codeTagProps:{style:{fontFamily:"'Fira Code', monospace",whiteSpace:"pre",display:"block"}},PreTag:"div",children:s})})]})};export{g as MethodsView};
