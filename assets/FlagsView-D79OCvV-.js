...
-f    Forcer
--all    Toutes branches
--oneline    Format log court`,x=({onBack:n,onPlayClickSound:i})=>{const{language:o}=c(),l=o==="fr"?f:u;return r.jsxs("div",{className:"relative min-h-[600px] animate-in slide-in-from-left duration-500 pb-12",children:[r.jsxs("div",{className:"flex items-center justify-between mb-8",children:[r.jsxs("h2",{className:"text-2xl font-black text-white flex items-center gap-3",children:[r.jsx("i",{className:"fas fa-flag text-yellow-300"}),o==="fr"?"Référence des options":"Flags Reference"]}),r.jsx("button",{onClick:()=>{i==null||i(),n()},className:"px-4 py-2 bg-white/5 hover:bg-white/10 rounded-xl text-sm font-bold transition-colors",children:o==="fr"?"Retour":"Back"})]}),r.jsx("div",{className:"flags-code-block glass rounded-2xl p-6 border border-yellow-400/40 overflow-x-auto text-slate-300 [&_code]:!text-slate-300",children:r.jsx(d,{language:"bash",style:p,customStyle:{padding:"1rem",margin:0,borderRadius:"0.75rem",background:"transparent",fontSize:"0.8rem",lineHeight:"1.6",fontFamily:"'Fira Code', monospace",color:s},codeTagProps:{style:{fontFamily:"'Fira Code', monospace",whiteSpace:"pre",display:"block"}},PreTag:"div",children:l})})]})};export{x as FlagsView};
