import{j as r}from"./react-vendor-vrmkM06s.js";import{u as l}from"./index-DSStPFiX.js";import{h as c,o as d}from"./syntax-highlighter-CMWetiVG.js";import"./questions-data-B_jqngk_.js";import"./detailed-explanations-x14tshUv.js";import"./short-explanations-DvdXFxcB.js";const o="hsl(0, 0%, 50%)",t="hsl(207, 82%, 66%)",e="hsl(39, 77%, 69%)",i="hsl(220, 14%, 71%)",m={...d,comment:{color:o,fontStyle:"normal"},prolog:{color:o},cdata:{color:o},string:{color:e},builtin:{color:t},selector:{color:e},inserted:{color:e},regex:{color:e},char:{color:e},"attr-value":{color:e},punctuation:{color:i},keyword:{color:"hsl(286, 60%, 67%)"},variable:{color:t},operator:{color:i},function:{color:t},constant:{color:e},number:{color:e},"attr-name":{color:t},"class-name":{color:e},boolean:{color:e},property:{color:t},tag:{color:t},symbol:{color:i},entity:{color:i},doctype:{color:i}},p=`# ----------------- ls -----------------
...
-f    Forcer
--all    Toutes branches
--oneline    Format log court`,S=({onBack:a})=>{const{language:s}=l(),n=s==="fr"?u:p;return r.jsxs("div",{className:"relative min-h-[600px] animate-in slide-in-from-left duration-500 pb-12",children:[r.jsxs("div",{className:"flex items-center justify-between mb-8",children:[r.jsxs("h2",{className:"text-2xl font-black text-white flex items-center gap-3",children:[r.jsx("i",{className:"fas fa-flag text-yellow-300"}),s==="fr"?"Référence des options":"Flags Reference"]}),r.jsx("button",{onClick:a,className:"px-4 py-2 bg-white/5 hover:bg-white/10 rounded-xl text-sm font-bold transition-colors",children:s==="fr"?"Retour":"Back"})]}),r.jsx("div",{className:"flags-code-block glass rounded-2xl p-6 border border-yellow-400/40 overflow-x-auto text-slate-300 [&_code]:!text-slate-300",children:r.jsx(c,{language:"bash",style:m,customStyle:{padding:"1rem",margin:0,borderRadius:"0.75rem",background:"transparent",fontSize:"0.8rem",lineHeight:"1.6",fontFamily:"'Fira Code', monospace",color:i},codeTagProps:{style:{fontFamily:"'Fira Code', monospace",whiteSpace:"pre",display:"block"}},PreTag:"div",children:n})})]})};export{S as FlagsView};
