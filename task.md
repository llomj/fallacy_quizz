...
| 1 | 1–90 (`level: 1` in `fallaciesData`) | 90 | **Standalone text complete** (see below) |
| … | … | … | … |
...
**Level 1:** Same checklist, but use `LEVEL_1_STANDALONE_EN` / `LEVEL_1_STANDALONE_FR` and the **Level 1** question rows in `fallaciesData.ts` (IDs **1–90**). Bulk content is generated by `scripts/generate-level1-standalone.mjs`; hand-edit individual IDs if a scenario needs richer pedagogy.
