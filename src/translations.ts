export const translations = {
  en: {
    ...
    hub: {
      ...
      correctToNext: "{correct} more correct & {percent}% accuracy → {persona}",
      lastRunStars: "Last run: {count} star(s)",
      randomModeAbsorbText: "Answer 15 random arguments from all levels. More correct answers and higher accuracy raise your rank (Tadpole → God Whale).",
      randomModeDescription: "Questions from all levels. Your rank goes up with total correct answers and accuracy; stars (0–5) show how well you did each run.",
    ...
    result: {
      ...
      evolutionScore: "Evolution Score",
      randomEvolution: "Random mode rank",
      correct: "correct",
    ...
    glossary: {
      ...
      saveToUserGlossary: "Save to Saved Glossary",
      removeFromSavedGlossary: "Remove from Saved Glossary",
      saved: "Saved",
    },
    ...
    gameRules: {
      ...
      randomBody: "In Random Mode, questions are drawn from all levels. Your rank (persona) goes up the more questions you get right: you need both a minimum number of correct answers and a minimum accuracy to reach each tier (Tadpole → Plankton → … → God Whale). Stars (0–5) are based on accuracy. XP is separate from Level mode. Switch between Level and Random anytime from Settings.",
      pointsTitle: "Points (XP)",
      pointsBody: "In Level mode you earn XP per correct answer; the top bar shows your level XP. In Random mode you earn separate Random-mode XP. The two point totals never mix.",
      starsTitle: "Stars",
      starsBody: "After each run (15 questions), you get 0–5 stars from accuracy: >10%→1, ≥20%→2, ≥40%→3, ≥60%→4, ≥80%→5. Stars show how well you did that run.",
      close: "Close",
    },
  },
  ...
  fr: {
    ...
    hub: {
      ...
      correctToNext: "{correct} correct de plus et {percent} % de précision → {persona}",
      lastRunStars: "Dernière run : {count} étoile(s)",
      randomModeAbsorbText: "Répondez à 15 arguments aléatoires de tous les niveaux. Plus de bonnes réponses et une meilleure précision élèvent votre rang (Têtard → Dieu Baleine).",
      randomModeDescription: "Questions de tous les niveaux. Votre rang monte avec le total de bonnes réponses et la précision ; les étoiles (0–5) reflètent chaque run.",
    ...
    result: {
      ...
      evolutionScore: "Score d'Évolution",
      randomEvolution: "Rang en mode aléatoire",
      correct: "correct",
    ...
    glossary: {
      ...
      saveToUserGlossary: "Enregistrer dans le glossaire sauvegardé",
      removeFromSavedGlossary: "Supprimer du glossaire sauvegardé",
      saved: "Enregistré",
    },
    ...
    settings: {
      ...
      count: "Compteur",
      idLog: "Journal ID",
      userGlossary: "Glossaire sauvegardé",
    ...
    gameRules: {
      ...
      randomBody: "En Mode Aléatoire, les questions sont tirées de tous les niveaux. Votre rang (persona) monte plus vous avez de bonnes réponses : il faut à la fois un nombre minimum de bonnes réponses et un minimum de précision pour chaque palier (Têtard → Plancton → … → Dieu Baleine). Les étoiles (0–5) dépendent de la précision. Les XP sont séparés du Mode Niveau. Basculez entre Niveau et Aléatoire depuis les Paramètres.",
      pointsTitle: "Points (XP)",
      pointsBody: "En Mode Niveau vous gagnez des XP par bonne réponse ; la barre du haut affiche vos XP de niveau. En Mode Aléatoire vous gagnez des XP Aléatoire séparés. Les deux totaux ne se mélangent pas.",
      starsTitle: "Étoiles",
      starsBody: "Après chaque run (15 questions), vous obtenez 0 à 5 étoiles selon la précision : >10 %→1, ≥20 %→2, ≥40 %→3, ≥60 %→4, ≥80 %→5. Les étoiles reflètent votre performance sur la run.",
      close: "Fermer",
    },
  },
};
