...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ["Mia asks, 'Why did you hide the missing charger under your bed?' even though Leo only asked where it was.", "Mia demande : « Pourquoi as-tu cache le chargeur manquant sous ton lit ? » alors que Leo a seulement demande ou il etait."],
  ["A teacher says, 'When did you start cheating on the quiz with your friend?' even though nobody accused the student of cheating.", "Un professeur demande : « Quand as-tu commence a tricher au quiz avec ton ami ? » alors que personne n'a accuse l'eleve de triche."],
