...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ['Sam says you either work overtime every night or you do not care about the team.', "Sam dit que soit tu fais des heures sup tous les soirs soit tu ne te soucies pas de l'equipe."],
  ['Mia says the trip was either luxury or a disaster, with no normal vacation in between.', "Mia dit que le voyage etait soit luxueux soit desastreux, sans vacance normale entre les deux."],
