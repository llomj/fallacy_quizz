...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ...
  ["A manager says, 'Accept the unpaid shift or I will cut your weekend hours,' so Lina agrees.", "Un manager dit : « Accepte le service non payé ou je réduirai tes heures du week-end », alors Lina accepte."],
  ["A teacher says, 'Use my answer key or I will fail your presentation,' so Noah stays silent.", "Un professeur dit : « Utilise ma grille de réponses ou je ferai échouer ta présentation », alors Noah se tait."],
  ["A landlord says, 'Sign the waiver or I will not fix your heater this winter,' so Eva signs.", "Un propriétaire dit : « Signe la décharge ou je ne réparerai pas ton chauffage cet hiver », alors Eva signe."],
  ["A coach says, 'Wear my shoes or you are off the roster,' so Omar buys them.", "Un coach dit : « Porte mes chaussures ou tu sors de l'équipe », alors Omar les achète."],
  ["A boss says, 'Agree with my plan or I will cancel your review,' so Priya agrees.", "Un patron dit : « Sois d'accord avec mon plan ou j'annulerai ton évaluation », alors Priya accepte."],
  ["A sibling says, 'Give me the console or I will hide your charger,' so Ben gives it up.", "Un frère dit : « Donne-moi la console ou je cacherai ton chargeur », alors Ben la donne."],
  ["A school monitor says, 'Question the rule and I will send you to the office,' so Tia stops asking.", "Un surveillant dit : « Questionne la règle et je t'enverrai au bureau », alors Tia cesse de poser des questions."],
  ["A committee chair says, 'Back my proposal or you will not be invited to the retreat,' so Zoe goes along.", "Un président de comité dit : « Soutiens ma proposition ou tu ne seras pas invité au séminaire », alors Zoe suit."],
  ["A neighbor says, 'Lower your music or I will complain every night,' so Liam turns it down.", "Un voisin dit : « Baisse la musique ou je me plaindrai chaque nuit », alors Liam baisse le volume."],
  ["A parent says, 'Agree with me or you lose your phone for a month,' so Mia nods.", "Un parent dit : « Sois d'accord avec moi ou tu perdras ton téléphone pendant un mois », alors Mia acquiesce."],
  ["A supervisor says, 'Edit the report my way or I will mark you unreliable,' so Cole edits it.", "Un superviseur dit : « Modifie le rapport à ma façon ou je te signalerai comme peu fiable », alors Cole le modifie."],
  ["A team leader says, 'Support my rule or I will remove you from the meeting notes,' so Nora supports it.", "Un chef d'équipe dit : « Soutiens ma règle ou je te retirerai des notes de réunion », alors Nora la soutient."],
  ["A landlord says, 'Pay this extra fee or expect an eviction notice,' so Ravi pays.", "Un propriétaire dit : « Paie ces frais supplémentaires ou attends-toi à un avis d'expulsion », alors Ravi paie."],
  ["A coach says, 'Back my drill or I will bench you all season,' so Theo backs it.", "Un coach dit : « Soutiens mon exercice ou je te mettrai sur le banc toute la saison », alors Theo le soutient."],
  ["A family elder says, 'Come to dinner or I will tell everyone you are rude,' so Ana comes.", "Un aîné de la famille dit : « Viens au dîner ou je dirai à tout le monde que tu es impoli », alors Ana vient."],
  ["A boss says, 'Use my template or I will block your raise,' so Grant uses it.", "Un patron dit : « Utilise mon modèle ou je bloquerai ta promotion », alors Grant l'utilise."],
  ["A store manager says, 'Buy the membership or I will not honor the coupon,' so Maya pays.", "Un responsable de magasin dit : « Achète l'abonnement ou je n'accepterai pas le coupon », alors Maya paie."],
  ["A coach says, 'Keep criticizing me and I will bench you next game,' so Eli stops.", "Un coach dit : « Continue à me critiquer et je te mettrai sur le banc au prochain match », alors Eli s'arrête."],
  ["A roommate says, 'Clean the kitchen my way or I will lock the cabinet,' so Sam agrees.", "Un colocataire dit : « Nettoie la cuisine à ma façon ou je verrouillerai le placard », alors Sam accepte."],
  ["A principal says, 'Keep your complaint private or you will be removed from the committee,' so Leila stays quiet.", "Un directeur dit : « Garde ta plainte privée ou tu seras retirée du comité », alors Leila se tait."],
  ["A parent says, 'Follow my career choice or I will stop helping with tuition,' so Nina obeys.", "Un parent dit : « Suis mon choix de carrière ou j'arrêterai d'aider pour les études », alors Nina obéit."],
  ["A boss says, 'Take the blame or I will fire the whole shift,' so Omar takes the blame.", "Un patron dit : « Prends la faute ou je licencierai tout le service », alors Omar prend la faute."],
  ["A teacher says, 'Accept my answer or retake the class,' so Ava accepts it.", "Un professeur dit : « Accepte ma réponse ou recommence le cours », alors Ava l'accepte."],
  ["A supervisor says, 'Approve the unpaid overtime or your schedule disappears,' so Ben approves it.", "Un superviseur dit : « Approuve les heures sup non payées ou ton planning disparaîtra », alors Ben approuve."],
  ["A coach says, 'Wear this jersey or you are out,' so Jules wears it.", "Un coach dit : « Porte ce maillot ou tu sors », alors Jules le porte."],
  ["A landlord says, 'Stop asking about the leak or I will renew someone else's lease first,' so Rina stops asking.", "Un propriétaire dit : « Arrête de poser des questions sur la fuite ou je renouvellerai d'abord le bail de quelqu'un d'autre », alors Rina arrête de demander."],
  ["A manager says, 'Sign the form today or I will give your project to someone else,' so Priya signs.", "Un manager dit : « Signe le formulaire aujourd'hui ou je donnerai ton projet à quelqu'un d'autre », alors Priya signe."],
  ["A neighbor says, 'Support my fence plan or I will complain about every noise you make,' so Theo supports it.", "Un voisin dit : « Soutiens mon projet de clôture ou je me plaindrai du moindre bruit que tu fais », alors Theo le soutient."],
  ["A school monitor says, 'Stop protesting the rule or I will send you to the office,' so Tia stops.", "Un surveillant dit : « Arrête de protester contre la règle ou je t'enverrai au bureau », alors Tia s'arrête."],
  ["A family elder says, 'Come to the dinner or I will say you are selfish,' so Mia comes.", "Un aîné de la famille dit : « Viens au dîner ou je dirai que tu es égoïste », alors Mia vient."],
  ["A boss says, 'Agree now or I will slash your hours next month,' so Leo agrees.", "Un patron dit : « Sois d'accord maintenant ou je réduirai tes heures le mois prochain », alors Leo accepte."],
  ["A club president says, 'Vote yes or you will not be invited to anything,' so Nora votes yes.", "Un président de club dit : « Vote oui ou tu ne seras invité à rien », alors Nora vote oui."],
  ["A supervisor says, 'Approve my deadline or I will mark you difficult,' so Omar approves it.", "Un superviseur dit : « Approuve mon échéance ou je te signalerai comme difficile », alors Omar l'approuve."],
  ["A parent says, 'Come home early or you lose dinner tonight,' so Ava comes home early.", "Un parent dit : « Rentre tôt ou tu perdras le dîner ce soir », alors Ava rentre tôt."],
  ["A coach says, 'Back my playbook or you do not start next game,' so Noah backs it.", "Un coach dit : « Soutiens mon manuel de jeu ou tu ne commenceras pas le prochain match », alors Noah le soutient."],
  ["A boss says, 'Use my template or I will block your bonus,' so Zoe uses it.", "Un patron dit : « Utilise mon modèle ou je bloquerai ta prime », alors Zoe l'utilise."],
  ["A sibling says, 'Lend me the game or I will tell on you,' so Max gives it over.", "Un frère dit : « Prête-moi le jeu ou je te dénoncerai », alors Max le donne."],
  ["A landlord says, 'Sign this waiver or I will not repair the heater,' so Lina signs.", "Un propriétaire dit : « Signe cette décharge ou je ne réparerai pas le chauffage », alors Lina signe."],
  ["A teacher says, 'Accept my answer or stay after class all week,' so Paul accepts it.", "Un professeur dit : « Accepte ma réponse ou reste après le cours toute la semaine », alors Paul l'accepte."],
  ["A manager says, 'Approve the redesign or I will cancel your contract,' so Grace approves it.", "Un manager dit : « Approuve la refonte ou j'annulerai ton contrat », alors Grace l'approuve."],
  ["A coach says, 'Stop questioning my drills or you will be benched,' so Iris stops.", "Un coach dit : « Arrête de questionner mes exercices ou tu seras mis sur le banc », alors Iris s'arrête."],
  ["A supervisor says, 'Keep quiet or I will move you to the worst desk,' so Dan keeps quiet.", "Un superviseur dit : « Reste silencieux ou je te mettrai au pire bureau », alors Dan se tait."],
  ["A family elder says, 'Attend the ceremony or I will blame you for disrespect,' so Nora attends.", "Un aîné de la famille dit : « Assiste à la cérémonie ou je t'accuserai d'irrespect », alors Nora y assiste."],
  ["A boss says, 'Agree with the new shift or I will cut your weekend hours,' so Eva agrees.", "Un patron dit : « Sois d'accord avec le nouveau planning ou je réduirai tes heures de week-end », alors Eva accepte."],
  ["A club leader says, 'Donate to my fundraiser or you will not be part of the photo,' so Tom donates.", "Un chef de club dit : « Fais un don à ma collecte ou tu ne feras pas partie de la photo », alors Tom donne."],
  ["A landlord says, 'Take the longer lease or I will not fix the heater,' so Kim takes it.", "Un propriétaire dit : « Prends le bail plus long ou je ne réparerai pas le chauffage », alors Kim le prend."],
  ["A manager says, 'Do not challenge me or I will assign you the worst shift,' so Zoe backs off.", "Un manager dit : « Ne me contredis pas ou je t'assignerai le pire service », alors Zoe recule."],
  ["A neighbor says, 'Lower your music or I will complain to the landlord tonight,' so Omar lowers it.", "Un voisin dit : « Baisse la musique ou je me plaindrai au propriétaire ce soir », alors Omar baisse le volume."],
  ["A parent says, 'Follow my plan or you lose your phone for a month,' so Mia follows it.", "Un parent dit : « Suis mon plan ou tu perds ton téléphone pendant un mois », alors Mia le suit."],
  ["A club president says, 'Vote for my rule or I will remove your badge,' so Theo votes yes.", "Un président de club dit : « Vote ma règle ou je retirerai ton badge », alors Theo vote oui."],
  ["A boss says, 'Wear the company badge or I will cancel your review,' so Mira wears it.", "Un patron dit : « Porte le badge de l'entreprise ou j'annulerai ton évaluation », alors Mira le porte."],
  ["A teacher says, 'Agree with the class rule or I will fail your participation grade,' so Sam agrees.", "Un professeur dit : « Sois d'accord avec la règle de classe ou je te mettrai une mauvaise note de participation », alors Sam est d'accord."],
  ["A team lead says, 'Use my slide deck or I will remove you from the presentation,' so Jules switches decks.", "Un chef d'équipe dit : « Utilise mon diaporama ou je te retirerai de la présentation », alors Jules change de support."],
  ["A boss says, 'Agree now or I will cut your hours next month,' so Nina agrees.", "Un patron dit : « Sois d'accord maintenant ou je réduirai tes heures le mois prochain », alors Nina accepte."],
];
