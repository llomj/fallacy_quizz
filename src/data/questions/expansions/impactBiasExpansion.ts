...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ...
  [`Eli believes one awkward call with his boss would overshadow all his other work.`, `Eli croit qu un appel genant avec son chef eclipsait tout son autre travail.`],
  ...
  [`Kira thinks one spilled drink at brunch would overshadow the rest of the meal.`, `Kira pense qu une boisson renversee au brunch eclipsait le reste du repas.`],
