...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ...
  ["Ava hears one story about a stolen bike and thinks every street parking spot is unsafe.", "Ava entend une histoire de velo vole et pense que chaque stationnement de rue est dangereux."],
  ["Ben sees one big paycheck from a doctor cousin and assumes every medical job pays that much.", "Ben voit un gros salaire chez un cousin medecin et suppose que tous les metiers medicaux paient autant."],
  ["Mia reads one bad review of a hotel and decides hotels in general are low quality.", "Mia lit un mauvais avis d'hotel et decide que les hotels sont en general de mauvaise qualite."],
  ["Theo hears that one friend failed a driving test and thinks most people fail it.", "Theo entend qu'un ami a rate son permis et pense que la plupart des gens le ratent."],
  ["Nina sees one viral clip of a messy flight and assumes flying is usually chaotic.", "Nina voit un clip viral d'un vol en desordre et suppose que voler est habituellement chaotique."],
  ["Omar hears one story about a fake refund and assumes all return policies are dishonest.", "Omar entend une histoire de faux remboursement et suppose que toutes les politiques de retour sont malhonnetes."],
  ["Priya sees one friend get into a top university and thinks admission there is common.", "Priya voit une amie entrer dans une grande universite et pense que l'admission y est courante."],
  ["Luca hears one cautionary tale about sushi and decides sushi makes people sick often.", "Luca entend une mise en garde sur les sushis et decide que les sushis rendent souvent malade."],
  ["Zoe sees one expensive concert ticket and assumes all concerts cost that much.", "Zoe voit un billet de concert cher et suppose que tous les concerts coutent autant."],
  ["Kai hears one scam story and thinks every online marketplace is a trap.", "Kai entend une histoire d'escroquerie et pense que chaque marche en ligne est un piege."],
  ["Rina watches one video of a dog bite and says all dogs are dangerous.", "Rina regarde une video de morsure de chien et dit que tous les chiens sont dangereux."],
  ["Maya hears one friend got sick after a flight and believes airplanes are unhealthy.", "Maya entend qu'une amie a ete malade apres un vol et croit que les avions sont mauvais pour la sante."],
  ["Leo sees one crowded subway car and concludes public transit is always packed.", "Leo voit une rame de metro bondée et conclut que les transports publics sont toujours pleins."],
  ["Sera hears one story about a rude cashier and assumes grocery stores are full of rude staff.", "Sera entend une histoire de caissier impoli et suppose que les supermarches sont pleins de personnel impoli."],
  ["Eli sees one failing startup headline and decides most startups fail immediately.", "Eli voit un titre sur une startup en echec et decide que la plupart des startups echouent tout de suite."],
  ["Jade hears one friend say their landlord ignored repairs and thinks all landlords do that.", "Jade entend une amie dire que son proprietaire a ignore les reparations et pense que tous les proprietaires font ca."],
  ["Noah reads one scary article about a bridge and assumes the bridge is probably unsafe.", "Noah lit un article effrayant sur un pont et suppose que le pont est probablement dangereux."],
  ["Ava sees one influencer vacation photo and assumes influencer life is always luxurious.", "Ava voit une photo de vacances d'un influenceur et suppose que la vie d'influenceur est toujours luxueuse."],
  ["Ben hears one sibling got lucky at the casino and thinks gambling usually pays off.", "Ben entend qu'un frere a eu de la chance au casino et pense que le jeu rapporte habituellement."],
  ["Mina sees one broken phone screen and says every new phone breaks easily.", "Mina voit un ecran de telephone casse et dit que tous les nouveaux telephones cassent facilement."],
  ["Owen hears one bad school lunch story and assumes all school lunches are awful.", "Owen entend une mauvaise histoire de repas scolaire et suppose que tous les repas scolaires sont horribles."],
  ["Tara sees one late train and thinks trains are unreliable in general.", "Tara voit un train en retard et pense que les trains sont en general peu fiables."],
  ["Finn hears one story about a rough camping night and decides camping is usually miserable.", "Finn entend une histoire de nuit de camping difficile et decide que le camping est habituellement penible."],
  ["Iris sees one cracked road sign and assumes the whole road network is neglected.", "Iris voit un panneau de route fissure et suppose que tout le reseau routier est neglige."],
  ["Cole hears one classmate got a perfect score and thinks tests must be easy for everyone.", "Cole entend qu'un camarade a eu une note parfaite et pense que les examens doivent etre faciles pour tout le monde."],
  ["Lena sees one boutique with high prices and decides the whole shopping district is overpriced.", "Lena voit une boutique aux prix eleves et decide que tout le quartier commerçant est trop cher."],
  ["Mia hears one friend say a medicine had side effects and assumes the medicine is risky for most people.", "Mia entend qu'une amie a eu des effets secondaires avec un medicament et suppose que le medicament est risqué pour la plupart des gens."],
  ["Theo sees one noisy classroom and concludes every classroom is chaotic.", "Theo voit une classe bruyante et conclut que toutes les classes sont chaotiques."],
  ["Nora hears one story about a bad haircut and thinks all salons disappoint customers.", "Nora entend une histoire de mauvaise coupe de cheveux et pense que tous les salons decevraient les clients."],
  ["Ethan sees one delayed parcel and assumes every delivery company is slow.", "Ethan voit un colis en retard et suppose que toutes les entreprises de livraison sont lentes."],
  ["Priya hears one story about a broken app and decides the whole app category is unreliable.", "Priya entend une histoire d'application en panne et decide que toute la categorie d'apps est peu fiable."],
  ["Luca sees one expensive coffee and thinks cafes are always overpriced.", "Luca voit un cafe cher et pense que les cafes sont toujours trop chers."],
  ["Juno hears one warning about a bridge collapse and believes all bridges are unsafe.", "Juno entend un avertissement sur l'effondrement d'un pont et croit que tous les ponts sont dangereux."],
  ["Rina sees one messy campsite and assumes all campers leave garbage behind.", "Rina voit un campement en desordre et suppose que tous les campeurs laissent des déchets."],
  ["Sam hears one friend win at poker and thinks poker is an easy way to make money.", "Sam entend qu'une amie a gagne au poker et pense que le poker est un moyen facile de gagner de l'argent."],
  ["Maya sees one difficult interview and decides every job interview is a disaster.", "Maya voit un entretien difficile et decide que tous les entretiens d'embauche sont des catastrophes."],
  ["Kai hears one neighbor complain about a clinic wait and assumes every clinic is slow.", "Kai entend un voisin se plaindre d'attendre dans une clinique et suppose que toutes les cliniques sont lentes."],
  ["Zoe sees one scary headline about city crime and thinks downtown is dangerous every night.", "Zoe voit un titre effrayant sur la criminalite en ville et pense que le centre-ville est dangereux chaque soir."],
  ["Omar hears one story about a failed recipe and assumes cooking is hard for everyone.", "Omar entend une histoire de recette ratee et suppose que cuisiner est difficile pour tout le monde."],
  ["Nia sees one loud gym class and thinks all gyms are unbearable.", "Nia voit un cours de sport bruyant et pense que toutes les salles de sport sont insupportables."],
  ["Jade hears one complaint about a boss and concludes all managers are terrible.", "Jade entend une plainte sur un chef et conclut que tous les managers sont terribles."],
  ["Luca sees one movie sequel flop and says all sequels are bad.", "Luca voit une suite de film echouer et dit que toutes les suites sont mauvaises."],
  ["Ava hears one family story about a bad flight and says flying is always stressful.", "Ava entend une histoire de famille sur un mauvais vol et dit que voler est toujours stressant."],
  ["Ben sees one dog bark at a fence and says every dog is aggressive.", "Ben voit un chien aboyer pres d'une cloture et dit que tous les chiens sont agressifs."],
  ["Mina hears one friend mention a fraud case and thinks every bank is shady.", "Mina entend qu'une amie parle d'une affaire de fraude et pense que toutes les banques sont louches."],
  ["Theo sees one broken escalator and decides every mall escalator is broken.", "Theo voit un escalier mecanique casse et decide que tous les escaliers mecaniques des centres commerciaux sont en panne."],
  ["Nora hears one rumor about a bad neighborhood and assumes the whole area is unsafe.", "Nora entend une rumeur sur un mauvais quartier et suppose que toute la zone est dangereuse."],
  ["Eli sees one classmate struggle and thinks school is impossible for most people.", "Eli voit un camarade avoir du mal et pense que l'ecole est impossible pour la plupart des gens."],
  ["Priya hears one story about a dishonest seller and thinks all online shops are scams.", "Priya entend une histoire de vendeur malhonnete et pense que toutes les boutiques en ligne sont des arnaques."],
  ["Noah sees one rainy picnic and believes picnics are usually ruined.", "Noah voit un pique-nique pluvieux et croit que les pique-niques sont habituellement gâchés."],
  ["Rina hears one complaint about a noisy apartment and assumes every apartment building is loud.", "Rina entend une plainte sur un appartement bruyant et suppose que tous les immeubles sont bruyants."],
  ["Maya sees one expensive gadget and concludes new gadgets are always too pricey.", "Maya voit un gadget cher et conclut que les nouveaux gadgets sont toujours trop chers."],
  ["Leo hears one story about a bad tutor and says all tutors are useless.", "Leo entend une histoire de mauvais tuteur et dit que tous les tuteurs sont inutiles."],
  ["Sera sees one cracked sidewalk and thinks the city never fixes anything.", "Sera voit un trottoir fissure et pense que la ville ne reparera jamais rien."],
  ["Tara hears one friend miss a train and decides trains are almost never on time.", "Tara entend qu'une amie a manque un train et decide que les trains ne sont presque jamais a l'heure."],
  ["Finn sees one messy restaurant table and assumes the whole kitchen is dirty.", "Finn voit une table de restaurant en desordre et suppose que toute la cuisine est sale."],
  ["Iris hears one story about a bad exam and thinks exams are impossible for everyone.", "Iris entend une histoire de mauvais examen et pense que les examens sont impossibles pour tout le monde."],
  ["Cole sees one failed software update and assumes every update will break things.", "Cole voit une mise a jour logicielle echouer et suppose que chaque mise a jour cassera quelque chose."],
  ["Lena hears one story about a rough vacation and says every trip is exhausting.", "Lena entend une histoire de vacances difficiles et dit que chaque voyage est epuisant."],
];
