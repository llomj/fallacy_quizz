...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ["Leo refuses to sell the mug he got for free at work, even though he never uses it and a neighbor offered good money.", "Leo refuse de vendre la tasse gratuite reçue au travail, même s'il ne l'utilise jamais et qu'un voisin a offert un bon prix."],
  ["Maya thinks her old chair is worth more than a better new one just because she has sat in it for years.", "Maya pense que sa vieille chaise vaut plus qu'une chaise neuve plus confortable simplement parce qu'elle l'utilise depuis des années."],
