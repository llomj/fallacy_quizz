...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ...
  [`Maya buys the latest earbuds because they just dropped this morning.`, `Maya achète les derniers écouteurs parce qu ils viennent de sortir ce matin.`],
  [`Leo says the new note app must be better because it is the one everyone posted about today.`, `Leo dit que la nouvelle application de notes doit être meilleure parce que c est celle dont tout le monde a parlé aujourd hui.`],
  [`Nina swaps her working planner for a fresh one because the cover says next year.`, `Nina échange son agenda qui fonctionne contre un nouveau parce que la couverture indique l annee prochaine.`],
  [`Owen trusts the brand-new mug because it feels more modern than his old one.`, `Owen fait confiance à la toute nouvelle tasse parce qu elle semble plus moderne que son ancienne.`],
  [`Priya buys the latest lamp because it is the newest thing on the shelf.`, `Priya achète la dernière lampe parce que c est la chose la plus récente en rayon.`],
  [`Ben says the fresh recipe app must be smarter because it launched last week.`, `Ben dit que la nouvelle application de recettes doit etre plus intelligente parce qu elle a ete lancée la semaine derniere.`],
  [`Tara switches to the new keyboard because newer sounds more advanced.`, `Tara passe au nouveau clavier parce que nouveau semble plus avance.`],
  [`Kai trusts the latest workout plan because all the ads say it is the future.`, `Kai fait confiance au dernier programme d entrainement parce que toutes les pubs disent que c est l avenir.`],
  [`Jules says the new coffee blend must be better because it just appeared in the store.`, `Jules dit que le nouveau mélange de café doit être meilleur parce qu il vient d apparaître en magasin.`],
  [`Ava picks the fresh backpack because the old model looks out of date.`, `Ava choisit le nouveau sac à dos parce que l ancien modèle a l air dépassé.`],
  [`Noah assumes the newest budgeting app is the smartest one because it is the latest release.`, `Noah suppose que la nouvelle application de budget est la plus intelligente parce que c est la dernière version.`],
  [`Mina believes the new detergent is better because it has a brighter bottle.`, `Mina croit que la nouvelle lessive est meilleure parce qu elle a une bouteille plus brillante.`],
  [`Eli says the brand-new grill must be superior because it came out this year.`, `Eli dit que le tout nouveau barbecue doit être superieur parce qu il est sorti cette année.`],
  [`Rina replaces a reliable phone setting with a new one because fresh feels better.`, `Rina remplace un réglage fiable du téléphone par un nouveau parce que le neuf semble meilleur.`],
  [`Hugo trusts the latest shoes because they are the newest model in the shop.`, `Hugo fait confiance aux dernières chaussures parce que c est le modèle le plus récent du magasin.`],
  [`Lina says the fresh school app must help more because everybody just downloaded it.`, `Lina dit que la nouvelle application scolaire doit aider davantage parce que tout le monde vient de la télécharger.`],
  [`Grant buys the newest mirror because the ad calls it the future of home style.`, `Grant achète le miroir le plus récent parce que la pub l appelle l avenir du style à la maison.`],
  [`Zoe says the new lunchbox is safer because it is the latest design.`, `Zoe dit que la nouvelle boîte à lunch est plus sûre parce que c est le dernier design.`],
  [`Milo trusts the fresh cleaning hack because old hacks feel tired.`, `Milo fait confiance à la nouvelle astuce de nettoyage parce que les anciennes semblent fatiguées.`],
  [`Theo assumes the new schedule is better because it was made after the old one.`, `Theo suppose que le nouvel horaire est meilleur parce qu il a été créé après l ancien.`],
  [`Pia chooses the brand-new water bottle because everyone online is posting it today.`, `Pia choisit la nouvelle bouteille d eau parce que tout le monde en ligne la publie aujourd hui.`],
  [`Finn says the latest phone case must be the safest because it just launched.`, `Finn dit que la dernière coque de téléphone doit être la plus sûre parce qu elle vient d être lancée.`],
  [`Maya buys the new chair because change feels innovative.`, `Maya achète la nouvelle chaise parce que le changement lui semble innovant.`],
  [`Sam trusts the newest study method because the video called it the future of learning.`, `Sam fait confiance à la nouvelle méthode d étude parce que la vidéo l a appelée l avenir de l apprentissage.`],
  [`Juno says the fresh wallpaper app must improve the phone because it is newer.`, `Juno dit que la nouvelle application de fonds d écran doit améliorer le téléphone parce qu elle est plus récente.`],
  [`Iris replaces a working blender with a newer one because newer sounds cleaner.`, `Iris remplace un blender qui fonctionne par un plus récent parce que plus récent semble plus propre.`],
  [`Cole says the latest desk organizer is best because it was just unveiled.`, `Cole dit que le dernier organiseur de bureau est le meilleur parce qu il vient d être dévoilé.`],
  [`Nora trusts the fresh travel tip because it was posted this morning.`, `Nora fait confiance au nouveau conseil de voyage parce qu il a été publié ce matin.`],
  [`Ari says the newest mug is the best because all the office chats mention it.`, `Ari dit que la nouvelle tasse est la meilleure parce que tous les chats du bureau en parlent.`],
  [`Rita buys the new mop because the product page says it is the future of cleaning.`, `Rita achète la nouvelle serpillière parce que la page produit dit que c est l avenir du nettoyage.`],
  [`Tia says the latest course is superior because it is the one with the fresh branding.`, `Tia dit que le dernier cours est supérieur parce que c est celui avec le nouveau visuel.`],
  [`Oli trusts the new snack because the packaging says limited release.`, `Oli fait confiance au nouvel en-cas parce que l emballage indique édition limitée.`],
  [`Lara says the brand-new route app is better because it looks more modern than the old one.`, `Lara dit que la nouvelle application d itinéraire est meilleure parce qu elle paraît plus moderne que l ancienne.`],
  [`Ben chooses the latest headphones because everyone in the office keeps showing them off.`, `Ben choisit les derniers écouteurs parce que tout le bureau ne cesse de les montrer.`],
  [`Mina believes the new calendar tool must help because it is the freshest option available.`, `Mina croit que le nouvel outil de calendrier doit aider parce que c est l option la plus récente disponible.`],
  [`Drew says the latest charger is better because old chargers are old.`, `Drew dit que le dernier chargeur est meilleur parce que les vieux chargeurs sont vieux.`],
  [`Jade trusts the new classroom game because it just arrived from the publisher.`, `Jade fait confiance au nouveau jeu de classe parce qu il vient tout juste de l editeur.`],
  [`Owen says the fresh fitness trend must work because it is trending right now.`, `Owen dit que la nouvelle tendance fitness doit marcher parce qu elle est tendance en ce moment.`],
  [`Mila buys the latest backpack because the label says 2026 model.`, `Mila achète le dernier sac à dos parce que l étiquette indique modèle 2026.`],
  [`Evan says the new coffee maker must be smarter because it has a fresh design.`, `Evan dit que la nouvelle cafetière doit être plus intelligente parce qu elle a un design récent.`],
];
