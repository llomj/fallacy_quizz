...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ["The ad says this smartwatch is better because it is the newest model on the shelf.", "La pub dit que cette montre connectée est meilleure parce que c'est le modèle le plus récent en rayon."],
  ["Mia buys a planner only because the cover says '2026 edition'.", "Mia achète un agenda seulement parce que la couverture dit « édition 2026 »."],
