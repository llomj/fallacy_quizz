...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ...
  ['Maya asks for a quieter coffee shop, and Ben says she wants to ban all talking in public forever.', 'Maya demande un cafe plus calme, et Ben dit qu elle veut interdire toute conversation en public pour toujours.'],
  ['Leo suggests clearer labels on shared food, and Nora says he wants to turn the kitchen into a courtroom.', 'Leo propose des etiquettes plus claires sur la nourriture partagee, et Nora dit qu il veut transformer la cuisine en tribunal.'],
  ['Priya says the office should buy one more printer, and Omar says she wants to flood the building with machines.', 'Priya dit que le bureau devrait acheter une imprimante de plus, et Omar dit qu elle veut inonder le batiment de machines.'],
  ['Noah asks for a later start to the school trip, and Lina says he wants to cancel the trip entirely.', 'Noah demande de commencer la sortie scolaire plus tard, et Lina dit qu il veut annuler completement la sortie.'],
  ['Ava wants a paper receipt option, and Theo says she wants to destroy online shopping.', 'Ava veut une option de reçu papier, et Theo dit qu elle veut detruire le shopping en ligne.'],
  ['Jules asks for one vegetarian lunch choice, and Mina says he wants to force everyone to live on salad.', 'Jules demande un seul choix vegetarien au dejeuner, et Mina dit qu il veut forcer tout le monde à vivre de salade.'],
  ['Hugo suggests a shorter meeting agenda, and Grant says he wants to make all work disappear.', 'Hugo propose un ordre du jour de reunion plus court, et Grant dit qu il veut faire disparaitre tout le travail.'],
  ['Rina wants better hallway lighting, and Zoe says she wants the building turned into a film set.', 'Rina veut un meilleur eclairage dans le couloir, et Zoe dit qu elle veut transformer le batiment en decor de film.'],
  ['Eli says the team should split the bill fairly, and Sam says he wants taxes on dinner.', 'Eli dit que l equipe devrait partager l addition de façon equitable, et Sam dit qu il veut mettre des impots sur le dîner.'],
  ['Tia asks for one quiet hour at home, and Juno says she wants a monastery with no fun.', 'Tia demande une heure calme à la maison, et Juno dit qu elle veut un monastere sans plaisir.'],
  ['Ben suggests a shorter status update, and Pia says he wants to silence the whole department.', 'Ben propose une mise à jour de statut plus courte, et Pia dit qu il veut faire taire tout le departement.'],
  ['Lara asks to label the spice jars, and Owen says she wants a chemistry lab in the kitchen.', 'Lara demande d etiqueter les pots d epices, et Owen dit qu elle veut un laboratoire de chimie dans la cuisine.'],
  ['Maya wants one extra bathroom break on a road trip, and Kira says she is planning a luxury cruise with scheduled stops.', 'Maya veut une pause toilettes de plus pendant un trajet, et Kira dit qu elle prevoit une croisiere de luxe avec des arrets planifies.'],
  ['Finn suggests muting one loud notification, and Avery says he wants to delete every app on the phone.', 'Finn propose de couper une notification bruyante, et Avery dit qu il veut supprimer toutes les applications du telephone.'],
  ['Nina asks for an extra day to finish the report, and Cole says she wants deadlines to vanish forever.', 'Nina demande un jour de plus pour finir le rapport, et Cole dit qu elle veut faire disparaitre les dates limites pour toujours.'],
  ['Mia recommends replacing one broken chair, and Dan says she wants to furnish the whole office like a palace.', 'Mia recommande de remplacer une chaise cassee, et Dan dit qu elle veut meubler tout le bureau comme un palais.'],
  ['Omar says the app should save drafts automatically, and Rosa says he wants users to stop thinking.', 'Omar dit que l application devrait enregistrer les brouillons automatiquement, et Rosa dit qu il veut que les utilisateurs arretent de penser.'],
  ['Jade suggests a smaller class project, and Yusuf says she wants school to become a vacation.', 'Jade propose un projet de classe plus petit, et Youssef dit qu elle veut transformer l ecole en vacances.'],
  ['Ari asks for better wheelchair access, and Lea says he wants to rebuild the whole street.', 'Ari demande une meilleure accessibilite en fauteuil, et Lea dit qu il veut reconstruire toute la rue.'],
  ['Pia wants the store to stop blasting music, and Finn says she wants a silent universe.', 'Pia veut que le magasin arrete de diffuser de la musique très forte, et Finn dit qu elle veut un univers silencieux.'],
  ['Grant suggests a cap on meeting length, and Tara says he wants to ban collaboration.', 'Grant propose une limite à la duree des reunions, et Tara dit qu il veut interdire la collaboration.'],
  ['Zoe asks for one more public bench, and Hugo says she wants everyone to live in the park.', 'Zoe demande un banc public de plus, et Hugo dit qu elle veut que tout le monde vive dans le parc.'],
  ['Ravi wants the software to stop asking for the password every five minutes, and Juno says he wants no security at all.', 'Ravi veut que le logiciel cesse de demander le mot de passe toutes les cinq minutes, et Juno dit qu il ne veut aucune securite du tout.'],
  ['Sofia suggests a paper copy of the schedule, and Eli says she wants to shut down the calendar app.', 'Sofia propose une copie papier de l horaire, et Eli dit qu elle veut fermer l application calendrier.'],
  ['Lina asks for one calm study room, and Ben says she wants the library turned into a spa.', 'Lina demande une salle d etude calme, et Ben dit qu elle veut transformer la bibliotheque en spa.'],
  ['Theo wants the coach to swap one drill, and Nora says he wants to rewrite the whole sport.', 'Theo veut que l entraineur change un exercice, et Nora dit qu il veut reecrire tout le sport.'],
  ['Maya asks the restaurant to list ingredients more clearly, and Owen says she wants a legal contract with every sandwich.', 'Maya demande que le restaurant indique mieux les ingredients, et Owen dit qu elle veut un contrat juridique avec chaque sandwich.'],
  ['Kai suggests one optional online class, and Rina says he wants students to live on screens forever.', 'Kai propose un cours en ligne facultatif, et Rina dit qu il veut que les eleves vivent devant des ecrans pour toujours.'],
  ['Ava wants the office to use the same folder names, and Malik says she is demanding total control of the filing room.', 'Ava veut que le bureau utilise les memes noms de dossiers, et Malik dit qu elle exige un controle total de la salle d archivage.'],
  ['Hana asks for better lighting in the hallway, and Grace says she wants the house turned into a movie set.', 'Hana demande un meilleur eclairage dans le couloir, et Grace dit qu elle veut transformer la maison en decor de film.'],
  ['Dylan suggests one extra safety sign at the pool, and Tia says he wants a lifeguard army on every tile.', 'Dylan propose un panneau de securite supplementaire a la piscine, et Tia dit qu il veut une armee de sauveteurs sur chaque carreau.'],
  ['Mina asks the cafe to offer a cheaper lunch special, and Sam says she wants every meal to cost nothing.', 'Mina demande que le cafe propose un plat du jour moins cher, et Sam dit qu elle veut que tous les repas soient gratuits.'],
  ['Owen proposes a shared calendar for the team, and Priya says he wants to police everyone s personal life.', 'Owen propose un calendrier partage pour l equipe, et Priya dit qu il veut surveiller la vie personnelle de tout le monde.'],
  ['Lea wants the school to print handouts on both sides, and Hugo says she wants to bankrupt the copy room.', 'Lea veut que l ecole imprime les documents recto verso, et Hugo dit qu elle veut ruiner la salle de photocopie.'],
