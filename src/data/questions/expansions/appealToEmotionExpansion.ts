...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ['A charity ad says your child will cry if you do not donate, so Mia gives money right away.', 'Une pub caritative dit que votre enfant pleurera si vous ne donnez pas, alors Mia donne tout de suite.'],
  ['A sales email says only a cold person would ignore this deal, so Leo clicks buy.', 'Un courriel de vente dit que seule une personne froide ignorerait cette offre, alors Leo clique sur acheter.'],
