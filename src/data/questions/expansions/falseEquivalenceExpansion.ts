...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ['Megan said forgetting one meeting is the same as missing a whole work shift.', "Megan a dit qu'oublier une reunion est la meme chose que manquer tout un quart de travail."],
  ['Owen compared being late to class with failing every exam, as if they were equal.', "Owen a compare arriver en retard en cours avec echouer a tous les examens, comme si c'etait equivalent."],
