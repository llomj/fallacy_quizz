...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ...
  ['Maya tests thirty breakfast combinations, keeps the one that matched her best grade, and says the cereal caused the grade.', 'Maya teste trente combinaisons de petit-dejeuner, garde celle qui correspondait a sa meilleure note et dit que la cereale a cause la note.'],
  ['Theo tries many ad slogans, keeps the one from the day sales rose, and says the wording caused the rise.', 'Theo essaie de nombreux slogans pub, garde celui du jour ou les ventes ont augmente et dit que la formulation a cause la hausse.'],
  ['Nina looks at dozens of study playlists, keeps the one before a good quiz, and declares the playlist a learning machine.', 'Nina examine des dizaines de playlists d etude, garde celle d avant un bon quiz et declare que la playlist est une machine a apprendre.'],
  ['Ben checks every shoe lace color, keeps the one from a winning game, and says the lace color brings wins.', 'Ben verifie toutes les couleurs de lacets, garde celle d un match gagne et dit que la couleur des lacets apporte les victoires.'],
  ['Omar reviews a pile of charts, keeps the slice that flatters the new policy, and says the policy is clearly proven.', 'Omar examine une pile de graphiques, garde la partie qui valorise la nouvelle politique et dit que la politique est clairement prouvee.'],
  ['Priya runs a bunch of polls, keeps the tiny group that likes her answer, and calls it the whole city.', 'Priya lance plein de sondages, garde le petit groupe qui aime sa reponse et appelle cela toute la ville.'],
  ['Leo tries many exercise routines, keeps the one before a good mood, and says the routine causes happiness.', 'Leo essaie de nombreuses routines sportives, garde celle d avant une bonne humeur et dit que la routine cause le bonheur.'],
  ['Rina compares dozens of snack brands, keeps the one from a great afternoon, and says the snack brand changed the day.', 'Rina compare des dizaines de marques de snacks, garde celle d un apres-midi genial et dit que la marque a change la journee.'],
  ['Jules tests multiple email subjects, keeps the one before a fast reply, and says the subject line guarantees speed.', 'Jules teste plusieurs objets d e-mail, garde celui d avant une reponse rapide et dit que l objet garantit la vitesse.'],
  ['Ava sorts through many headlines, keeps the one that matched a good weekend, and says the headline explains the weekend.', 'Ava trie de nombreux titres, garde celui qui correspondait a un bon week-end et dit que le titre explique le week-end.'],
  ['Mia tests a pile of habit trackers, keeps the one from a productive Monday, and says the tracker caused the good week.', 'Mia teste une pile de suivis d habitudes, garde celui d un lundi productif et dit que le suivi a cause la bonne semaine.'],
  ['Noah compares dozens of recipe tweaks, keeps the one from the tastiest batch, and says that ingredient is the secret to happiness.', 'Noah compare des dizaines d ajustements de recettes, garde celui du lot le plus bon et dit que cet ingredient est le secret du bonheur.'],
  ['Zoe checks many playlist names, keeps the one from a great run, and says the title made the run faster.', 'Zoe verifie de nombreux noms de playlist, garde celui d une bonne course et dit que le titre a rendu la course plus rapide.'],
  ['Eli looks through classroom seating charts, keeps the one from a quiet lesson, and says the seat position creates focus.', 'Eli examine des plans de classe, garde celui d un cours calme et dit que la position du siege cree la concentration.'],
  ['Luna tries different coffee mugs, keeps the one from a lucky morning, and says the mug brought the good mood.', 'Luna essaie differentes tasses a cafe, garde celle d un matin chanceux et dit que la tasse a apporte la bonne humeur.'],
  ['Owen tests several study timers, keeps the one from a high score, and says the timer guarantees better grades.', 'Owen teste plusieurs minuteurs d etude, garde celui d une bonne note et dit que le minuteur garantit de meilleures notes.'],
  ['Iris checks snack pairings, keeps the one from an easy afternoon, and says the snack makes every task easier.', 'Iris verifie des associations de collations, garde celle d un apres-midi facile et dit que la collation rend chaque tache plus simple.'],
  ['Caleb reviews many phone wallpapers, keeps the one from a nice meeting, and says the wallpaper improves work.', 'Caleb examine de nombreux fonds d ecran de telephone, garde celui d une bonne reunion et dit que le fond d ecran ameliore le travail.'],
  ['Nora studies dozens of study routines, keeps the one from a bright morning, and says the routine causes learning.', 'Nora etudie des dizaines de routines d etude, garde celle d un matin lumineux et dit que la routine cause l apprentissage.'],
  ['Finn compares different notebook layouts, keeps the one from a good quiz, and says the layout is why he remembered more.', 'Finn compare differents agencements de cahier, garde celui d un bon quiz et dit que l agencement explique pourquoi il a mieux retenu.'],
  ['Ruby looks at many lunch habits, keeps the one from a cheerful day, and says that lunch habit makes people kinder.', 'Ruby examine de nombreuses habitudes de dejeuner, garde celle d un jour joyeux et dit que cette habitude rend les gens plus gentils.'],
  ['Mason tests a dozen keyboard shortcuts, keeps the one from a fast reply, and calls it the reason his day went well.', 'Mason teste une douzaine de raccourcis clavier, garde celui d une reponse rapide et dit que c est la raison pour laquelle sa journee s est bien passee.'],
  ['Harper samples many alarm tones, keeps the one from a peaceful morning, and says the tone leads to better decisions.', 'Harper essaie de nombreuses sonneries de reveil, garde celle d un matin paisible et dit que la sonnerie mene a de meilleures decisions.'],
  ['Jasper checks every hydration bottle, keeps the one from a good workout, and says the bottle caused the workout.', 'Jasper verifie chaque gourde, garde celle d un bon entrainement et dit que la gourde a cause l entrainement.'],
  ['Tara compares many grocery lists, keeps the one from a cheap trip, and says the list is the money-saving miracle.', 'Tara compare de nombreuses listes de courses, garde celle d un trajet bon marche et dit que la liste est le miracle pour economiser.'],
  ['Kai looks through a stack of memes, keeps the one from a lucky afternoon, and says the meme format is scientifically superior.', 'Kai parcourt une pile de memes, garde celui d un apres-midi chanceux et dit que le format du meme est scientifiquement superieur.'],
  ['Sofia tests many meeting agendas, keeps the one from a smooth project, and says the agenda is what made the project work.', 'Sofia teste de nombreux ordres du jour, garde celui d un projet fluide et dit que l ordre du jour est ce qui a fait marcher le projet.'],
  ['Dylan watches several weather apps, keeps the one from a sunny walk, and says the app caused the sunshine.', 'Dylan regarde plusieurs applications meteo, garde celle d une promenade ensoleillee et dit que l application a cause le soleil.'],
  ['Eva tries different thank-you notes, keeps the one from a kind response, and says the note always gets kindness back.', 'Eva essaie differentes notes de remerciement, garde celle d une reponse gentille et dit que la note provoque toujours de la gentillesse en retour.'],
  ['Aria reviews many desk plants, keeps the one from a focused afternoon, and says the plant makes concentration bloom.', 'Aria examine de nombreuses plantes de bureau, garde celle d un apres-midi concentre et dit que la plante fait fleurir la concentration.'],
  ['Leo sorts through recipe cards, keeps the one from a crowd-pleasing dinner, and says the recipe guarantees applause.', 'Leo trie des fiches de recettes, garde celle d un diner qui a plu a tout le monde et dit que la recette garantit les applaudissements.'],
  ['Mila checks the labels on dozens of water bottles, keeps the one from a strong practice session, and says the label improved performance.', 'Mila verifie les etiquettes de dizaines de bouteilles d eau, garde celle d une bonne seance et dit que l etiquette a ameliore la performance.'],
  ['Jonah tests many subject lines, keeps the one from a quick response, and says the wording itself forces replies.', 'Jonah teste de nombreux objets d e-mail, garde celui d une reponse rapide et dit que la formulation force les reponses.'],
  ['Chloe studies banner colors, keeps the one from a busy open house, and says the color is why everyone came.', 'Chloe etudie les couleurs de bannieres, garde celle d une journee de portes ouvertes animee et dit que la couleur explique pourquoi tout le monde est venu.'],
  ['Omar checks a long list of room setups, keeps the one from a relaxed workshop, and says the setup cured the stress.', 'Omar verifie une longue liste de configurations de salle, garde celle d un atelier detendu et dit que l amenagement a gueri le stress.'],
  ['Lena tries many evening routines, keeps the one from an easy morning, and says the routine makes mornings perfect.', 'Lena essaie de nombreuses routines du soir, garde celle d un matin facile et dit que la routine rend les matins parfaits.'],
  ['Aiden compares many scoreboard views, keeps the one from a winning streak, and says the view caused the streak.', 'Aiden compare de nombreuses vues de tableau de scores, garde celle d une serie de victoires et dit que la vue a cause la serie.'],
  ['Pia tests countless note colors, keeps the one from a calm test day, and says the color improved the test score.', 'Pia teste d innombrables couleurs de notes, garde celle d un jour de controle calme et dit que la couleur a ameliore la note.'],
  ['Ben checks many morning playlists, keeps the one from a good commute, and says the playlist creates the commute.', 'Ben verifie de nombreuses playlists du matin, garde celle d un bon trajet et dit que la playlist cree le trajet.'],
  ['Riley compares many calendar colors, keeps the one from a smooth week, and says the color scheme made the week calm.', 'Riley compare de nombreuses couleurs de calendrier, garde celle d une semaine fluide et dit que le code couleur a rendu la semaine calme.'],
];
