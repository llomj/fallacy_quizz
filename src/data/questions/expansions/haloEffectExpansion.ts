...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ...
  ['Maya sees a manager open the door for someone and decides they must be a great leader in every department.', "Maya voit un responsable ouvrir la porte a quelqu un et decide qu il doit etre un grand leader dans tous les departements."],
  ['Ben watches a student explain one homework question clearly and assumes the student is brilliant at every subject.', "Ben regarde un eleve expliquer clairement une question de devoir et suppose que l eleve est brillant dans toutes les matieres."],
  ['Priya likes a nurse’s calm tone and concludes the nurse is perfect at every medical task.', "Priya aime le ton calme d une infirmiere et conclut qu elle est parfaite pour toutes les taches medicales."],
  ['Noah sees a mechanic clean their hands before work and decides they must be honest about every repair.', "Noah voit un mecanicien se laver les mains avant de travailler et decide qu il doit etre honnete sur toutes les reparations."],
  ['Lina hears one thoughtful joke from a coworker and assumes the coworker is also amazing at budgeting.', "Lina entend une blague reflechie d une collegue et suppose que cette collegue est aussi formidable pour faire un budget."],
  ['Theo notices a teacher with a neat desk and decides the teacher is wise about life, not just school.', "Theo remarque qu un professeur a un bureau range et decide que ce professeur est sage dans la vie, pas seulement a l ecole."],
  ['Ava watches a barista remember one order and assumes the barista can remember everyone’s secrets too.', "Ava voit un barista retenir une commande et suppose que le barista peut aussi retenir tous les secrets de tout le monde."],
  ['Omar sees a teen dress well for prom and concludes they must be mature in every serious situation.', "Omar voit un ado bien habille pour le bal et conclut qu il doit etre mature dans toute situation serieuse."],
  ['Rosa thinks a neighbor is a math whiz because the neighbor painted a pretty fence.', "Rosa pense qu un voisin est un genie des maths parce que le voisin a peint une jolie cloture."],
  ['Jules hears one confident voicemail and decides the caller is trustworthy in all matters.', "Jules entend un seul message vocal assure et decide que l appelant est digne de confiance sur tout."],
  ['Eli sees a principal smile during recess and assumes the principal is excellent at handling crises.', "Eli voit un directeur sourire pendant la recreation et suppose que le directeur est excellent pour gerer les crises."],
  ['Mina watches a classmate share snacks and starts treating them like a genius and a saint.', "Mina voit une camarade partager des collations et commence a la traiter comme un genie et une sainte."],
  ['Hugo likes the way a librarian whispers and assumes they also know the answer to every problem.', "Hugo aime la facon dont une bibliothecaire chuchote et suppose qu elle connait aussi la reponse a tous les problemes."],
  ['Lea sees a coach clap after practice and concludes the coach is an expert in every life choice.', "Lea voit un entraineur applaudir apres l entrainement et conclut que l entraineur est expert dans chaque choix de vie."],
  ['Max decides a receptionist is highly competent in law because the lobby was decorated nicely.', "Max decide qu une receptionniste est tres competente en droit parce que le hall etait joliment decoré."],
  ['Tia likes one clean slide deck and assumes the presenter can also handle hiring, finance, and public speaking.', "Tia aime un seul diaporama propre et suppose que le presentateur peut aussi gerer le recrutement, les finances et la prise de parole."],
  ['Paul thinks a classmate who solved a puzzle is automatically better than everyone at every school task.', "Paul pense qu un camarade qui a resolu un casse-tete est automatiquement meilleur que tout le monde pour toutes les taches scolaires."],
  ['Yara sees a driver help with groceries and decides the driver must be brilliant in every occupation.', "Yara voit un chauffeur aider avec les courses et decide que le chauffeur doit etre brillant dans tous les metiers."],
  ['Dan judges a new friend’s whole character from the fact that they sent a nice thank-you text.', "Dan juge tout le caractere d un nouvel ami a partir du fait qu il a envoye un gentil message de remerciement."],
  ['Nina thinks a dentist who wore fun socks must also be great at parenting, cooking, and investing.', "Nina pense qu un dentiste qui porte des chaussettes amusantes doit aussi etre formidable comme parent, cuisinier et investisseur."],
  ['Kim assumes a clerk with a neat badge is probably wiser than the CEO.', "Kim suppose qu un employe avec un badge propre est probablement plus sage que le PDG."],
  ['Salma believes a volunteer is exceptional at every task after watching them hand out water bottles.', "Salma croit qu un benevole est exceptionnel pour toutes les taches apres l avoir vu distribuer des bouteilles d eau."],
  ['Grant sees one kind email from a landlord and decides the landlord is fair in every possible dispute.', "Grant voit un courriel gentil d un proprietaire et decide que le proprietaire est juste dans tous les conflits possibles."],
  ['Mila thinks a tutor is a genius because they used a colorful marker during class.', "Mila pense qu un tuteur est un genie parce qu il a utilise un marqueur colore en classe."],
  ['Owen hears a smooth apology and concludes the speaker is mature in every aspect of adulthood.', "Owen entend des excuses fluides et conclut que l orateur est mature dans tous les aspects de l age adulte."],
  ['Jin notices a chef who smiles at customers and decides they could also run a school, a bank, and a city.', "Jin remarque qu un chef sourit aux clients et decide qu il pourrait aussi diriger une ecole, une banque et une ville."],
  ['Pia sees a technician fix one printer and assumes they can solve any problem in the world.', "Pia voit un technicien reparer une imprimante et suppose qu il peut resoudre n importe quel probleme dans le monde."],
  ['Ben likes a coworker’s haircut and immediately trusts their opinion on politics.', "Ben aime la coupe de cheveux d une collegue et fait immediatement confiance a son opinion sur la politique."],
  ['Zoe thinks a wedding speaker is a perfect human being because the toast got applause.', "Zoe pense qu un orateur de mariage est un etre humain parfait parce que le toast a recu des applaudissements."],
  ['Ravi assumes a doctor with a calm waiting room is also a great novelist.', "Ravi suppose qu un medecin avec une salle d attente calme est aussi un grand romancier."],
  ['Sofia treats a teacher as a life coach after one student raises a hand happily.', "Sofia traite un professeur comme un coach de vie apres qu un eleve a leve la main avec joie."],
  ['Lara believes a barber is clever about business because the haircut looked sharp.', "Lara croit qu un coiffeur est intelligent en affaires parce que la coupe avait belle allure."],
  ['Cole decides a neighbor is reliable for everything because they watered a shared plant.', "Cole decide qu un voisin est fiable pour tout parce qu il a arrose une plante commune."],
  ['Maya thinks a cashier is a natural leader because they said have a nice day.', "Maya pense qu une caissiere est une leader naturelle parce qu elle a dit bonne journee."],
  ['Ezra sees one well-timed clap and assumes the audience member is wise about every topic.', "Ezra voit un seul applaudissement bien place et suppose que la personne dans le public est sage sur tous les sujets."],
  ['Nora judges a new hire’s entire competence from one polished introduction.', "Nora juge toute la competence d une nouvelle recrue a partir d une seule presentation soignee."],
  ['Ari sees a clean apron and assumes the baker is also great at diplomacy.', "Ari voit un tablier propre et suppose que le boulanger est aussi excellent en diplomatie."],
  ['Mina says a friendly neighbor must be an expert investor because they held the elevator door.', "Mina dit qu un voisin sympathique doit etre un expert en investissement parce qu il a retenu la porte de l ascenseur."],
  ['Leo hears one good speech and starts treating the speaker like a perfect authority on everything.', "Leo entend un bon discours et commence a traiter l orateur comme une autorite parfaite sur tout."],
  ['Tara thinks a student with neat handwriting must be better than everyone else in every way.', "Tara pense qu un eleve avec une ecriture soignee doit etre meilleur que tout le monde en tout point."],
  ['Hana believes a smiling bus driver must also be excellent at psychology.', "Hana croit qu un chauffeur de bus souriant doit aussi etre excellent en psychologie."],
];
