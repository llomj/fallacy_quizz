...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ...
  ['Rina heard a rumor about the mayor and treated it as a direct quote from the mayor.', "Rina a entendu une rumeur sur le maire et l'a traitee comme une citation directe du maire."],
  ['Jules saw a screenshot of a chat and assumed the screenshot creator wrote every message.', "Jules a vu une capture d'ecran d'une discussion et a suppose que la personne qui l'avait prise avait ecrit chaque message."],
  ['Mina blamed the oven for a burnt pie that had actually been left too long while carrying groceries.', "Mina a accuse le four pour une tarte brulee qui avait en fait ete oubliee trop longtemps pendant qu'elle portait les courses."],
  ['Eli assumed the podcaster personally endorsed every quote he repeated on the show.', "Eli a suppose que l animateur du podcast approuvait personnellement chaque citation qu'il repetait dans l'emission."],
  ['Tara read a slogan on a tote bag and thought the bag maker had written the city slogan.', "Tara a lu un slogan sur un sac fourre-tout et a pense que le fabricant du sac avait ecrit le slogan de la ville."],
  ['Kai heard a child tell a joke and credited the daycare teacher as the original writer.', "Kai a entendu un enfant raconter une blague et a attribue sa creation a l'enseignante de la garderie."],
  ['Zoe saw a photo caption and assumed the photographer was also the person in the photo.', "Zoe a vu une legende de photo et a suppose que le photographe etait aussi la personne sur la photo."],
  ['Noah blamed the monitor for a frozen game that was really caused by a bad update.', "Noah a accuse l'ecran pour un jeu bloque alors qu'il etait en realite cause par une mauvaise mise a jour."],
  ['Mila heard a weather joke from a coworker and concluded the coworker had authored the forecast.', "Mila a entendu une blague meteo d'un collegue et a conclu que le collegue avait redige le bulletin."],
  ['Grant saw a quote on a meme and thought his uncle had said it at dinner.', "Grant a vu une citation sur un mème et a pense que son oncle l'avait dite au diner."],
  ['Lina blamed the router for a power outage that actually hit the whole street.', "Lina a accuse le routeur pour une panne de courant qui avait en fait touche toute la rue."],
  ['Pia heard her friend repeat a statistic and assumed the friend had run the survey.', "Pia a entendu son amie repeter une statistique et a suppose que son amie avait mene l'enquete."],
  ['Hugo saw a funny quote card and believed the designer had spoken those words on stage.', "Hugo a vu une carte de citation amusante et a cru que le designer avait prononce ces mots sur scene."],
  ['Rita heard a proverb from her grandmother and assumed she invented it last week.', "Rita a entendu un proverbe de sa grand-mere et a suppose qu'elle l'avait invente la semaine derniere."],
  ['Juno saw a viral quote image and believed the image itself was the speaker.', "Juno a vu une image de citation virale et a cru que l'image elle-meme etait la personne qui parlait."],
  ['Maya blamed the bike for a flat tire even though a nail in the road caused it.', "Maya a accuse le velo pour le pneu creve alors qu'un clou sur la route en etait la cause."],
  ['Owen assumed the neighbor who mentioned the noise had caused the noise.', "Owen a suppose que le voisin qui a mentionne le bruit avait provoque le bruit."],
  ['Sofia heard a quote on a podcast and assumed the host had spoken with the original author in person.', "Sofia a entendu une citation dans un podcast et a suppose que l'animateur avait parle en personne avec l'auteur original."],
  ['Drew blamed the seatbelt alarm for the car not starting.', "Drew a accuse le bip de la ceinture de securite pour la voiture qui ne demarrait pas."],
  ['Ari saw a meme about taxes and thought the page had written the tax law.', "Ari a vu un mème sur les impots et a pense que la page avait redige la loi fiscale."],
  ['Tessa heard her cousin repeat a rumor and concluded her cousin was the first source.', "Tessa a entendu sa cousine repeter une rumeur et a conclu que sa cousine en etait la premiere source."],
  ['Jonah heard a phrase in a movie and told everyone the actor personally coined it.', "Jonah a entendu une expression dans un film et a dit a tout le monde que l'acteur l'avait inventee lui-meme."],
  ['Layla saw a meme remix and assumed the remixer had created the original photo.', "Layla a vu un mème remixe et a suppose que la personne qui l'avait remixe avait cree la photo originale."],
];
