...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ...
  ,
  ["Ava says one fake tweet can force the whole team to spend the morning writing a calm response.", "Ava dit qu'un seul faux tweet peut obliger toute l'equipe a passer la matinee a rediger une reponse calme."],
  ["Milo says a rumor can be typed in five seconds and still demand a full meeting to undo.", "Milo dit qu'une rumeur peut etre tapee en cinq secondes et demander quand meme une reunion complete pour etre defaite."],
  ["Rina says the lie is tiny, but the cleanup turns into a giant group project.", "Rina dit que le mensonge est minuscule, mais que le nettoyage devient un immense travail de groupe."],
  ["Noah says a wild claim can be posted during lunch and still be draining everyone at closing time.", "Noah dit qu'une affirmation folle peut etre publiee pendant le dejeuner et continuer a epuiser tout le monde a la fermeture."],
  ["Theo says the bad idea spreads fast because it sounds confident, not because it is true.", "Theo dit que la mauvaise idee se propage vite parce qu'elle a l'air sure d'elle, pas parce qu'elle est vraie."],
  ["Maya says debunking nonsense takes receipts, screenshots, and patience.", "Maya dit que demonter des absurdites demande des preuves, des captures d'ecran et de la patience."],
  ["Jules says one careless post can create an afternoon of corrections for three different people.", "Jules dit qu'un seul message negligé peut creer tout un apres-midi de corrections pour trois personnes differentes."],
  ["Priya says the false claim gets to be vague, but the rebuttal has to be exact.", "Priya dit que la fausse affirmation peut rester vague, mais que la reponse doit etre precise."],
  ["Ben says it is much easier to click send than to repair the mess afterward.", "Ben dit qu'il est bien plus facile d'appuyer sur envoyer que de reparer le bazar ensuite."],
  ["Omar says one sloppy chart can turn a short conversation into a lecture.", "Omar dit qu'un seul graphique bancal peut transformer une courte conversation en cours magistral."],
  ["Lina says the person who posted the nonsense is already asleep while everyone else is still fact-checking.", "Lina dit que la personne qui a publie l'absurdite dort deja pendant que les autres continuent de verifier les faits."],
  ["Eli says a bad take is cheap to publish because it borrows other people's attention.", "Eli dit qu'un mauvais avis est bon marche a publier parce qu'il utilise l'attention des autres."],
  ["Nia says correcting a fake story means teaching the whole background the story skipped.", "Nia dit que corriger une fausse histoire revient a enseigner tout le contexte que l'histoire a saute."],
  ["Mina says the correction needs evidence, but the rumor only needed confidence.", "Mina dit que la correction a besoin de preuves, alors que la rumeur n'avait besoin que d'assurance."],
  ["Zoe says one false accusation can eat up the time planned for an entire project update.", "Zoe dit qu'une seule fausse accusation peut engloutir le temps prevu pour toute une mise a jour de projet."],
  ["Kai says nonsense is fast because it does not stop to check itself.", "Kai dit que les absurdites vont vite parce qu'elles ne s'arretent pas pour se verifier elles-memes."],
  ["Talia says the repair job is always bigger than the original damage looked on paper.", "Talia dit que le travail de reparation est toujours plus grand que les degats initiaux ne le semblaient sur le papier."],
  ["Aria says one misleading post can make the whole chat spend hours untangling it.", "Aria dit qu'un seul message trompeur peut faire passer des heures au groupe a le demeler."],
  ["Finn says the lie had no notes, but the truth needs citations and context.", "Finn dit que le mensonge n'avait pas de notes, mais que la verite a besoin de citations et de contexte."],
  ["Mia says a rumor can ride on vibes while a correction has to do real work.", "Mia dit qu'une rumeur peut voyager sur des impressions, alors qu'une correction doit vraiment travailler."],
  ["Owen says the nonsense gets a quick laugh, and the correction gets the homework.", "Owen dit que les absurdites provoquent un rire rapide, et que la correction herite des devoirs."],
  ["Jade says one fake claim can cost the rest of the afternoon in explanations.", "Jade dit qu'une seule fausse affirmation peut couter le reste de l'apres-midi en explications."],
  ["Luca says the hard part is not spotting the lie but rebuilding trust around it.", "Luca dit que la difficulte n'est pas de reperer le mensonge mais de reconstruire la confiance autour."],
  ["Sera says a dramatic story is easy to share because it avoids details.", "Sera dit qu'une histoire dramatique est facile a partager parce qu'elle evite les details."],
  ["Nina says one wrong post can trigger five clarifying messages and still leave confusion.", "Nina dit qu'un seul mauvais message peut declencher cinq messages de clarification et laisser quand meme de la confusion."],
  ["Theo says the correction has to be polite, which makes it take even longer.", "Theo dit que la correction doit etre polie, ce qui la rend encore plus longue."],
  ["Priya says the made-up claim is a shortcut, but the truth is the long road.", "Priya dit que l'affirmation inventee est un raccourci, mais que la verite est la longue route."],
  ["Maya says a single lie can make everyone check sources they should not have needed to check.", "Maya dit qu'un seul mensonge peut pousser tout le monde a verifier des sources qu'ils n'auraient pas du avoir a verifier."],
  ["Ben says the rumor is a spark and the correction is the fire drill.", "Ben dit que la rumeur est une etincelle et que la correction est l'exercice d'evacuation."],
  ["Omar says the false claim moves at meme speed, but the fix moves at office speed.", "Omar dit que la fausse affirmation avance a la vitesse d'un mème, mais que la correction avance a la vitesse du bureau."],
  ["Lina says the lie sounds easy because it does not have to survive questions.", "Lina dit que le mensonge semble facile parce qu'il n'a pas a survivre aux questions."],
  ["Eli says every correction needs more words than the original nonsense wanted to spend.", "Eli dit que chaque correction a besoin de plus de mots que les absurdites originales n'en voulaient depenser."],
  ["Ava says one sloppy claim can turn a group chat into a research project.", "Ava dit qu'une seule affirmation mal faite peut transformer un groupe de discussion en projet de recherche."],
  ["Noah says the falsehood gets to be catchy, but the correction has to be careful.", "Noah dit que la faussete peut etre accrocheuse, mais que la correction doit etre minutieuse."],
  ["Rina says it is unfair how fast nonsense travels compared with the time it takes to clean it up.", "Rina dit qu'il est injuste de voir a quelle vitesse les absurdites voyagent compare au temps qu'il faut pour les nettoyer."],
  ["Milo says a bad chart can hijack a whole lunch break and still need a follow-up email.", "Milo dit qu'un mauvais graphique peut detourner toute une pause dejeuner et exiger quand meme un e-mail de suivi."],
  ["Jade says the claim is a shortcut because it skips the part where it proves itself.", "Jade dit que l'affirmation est un raccourci parce qu'elle saute la partie ou elle doit se prouver elle-meme."],
  ["Theo says the truth needs slow cooking, while the lie is instant noodles.", "Theo dit que la verite a besoin d'une cuisson lente, tandis que le mensonge est un sachet de nouilles instantanees."],
  ["Nia says one false post can turn into an all-hands correction session.", "Nia dit qu'un seul faux message peut se transformer en session de correction pour tout le monde."],
  ["Priya says the story may be wrong, but it is annoyingly efficient at wasting time.", "Priya dit que l'histoire est peut-etre fausse, mais qu'elle est agaçamment efficace pour faire perdre du temps."]
];
