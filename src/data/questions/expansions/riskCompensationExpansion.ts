...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ...
  ["Nora bikes faster because her helmet has a brighter safety sticker.", "Nora fait du velo plus vite parce que son casque a un autocollant de securite plus visible."],
  ["Eli crosses the street without looking because his jacket is reflective.", "Eli traverse la rue sans regarder parce que sa veste est reflechissante."],
  ["Lina drives closer to the car ahead because her lane assist keeps beeping.", "Lina se rapproche de la voiture devant elle parce que l assistance de voie sonne sans cesse."],
  ["Grant takes the stairs two at a time because the handrail feels sturdier now.", "Grant monte les escaliers deux par deux parce que la rampe semble plus solide maintenant."],
  ["Tia clicks a sketchy link more casually because the email client shows a warning badge.", "Tia clique plus legerement sur un lien douteux parce que le client mail affiche un badge d avertissement."],
  ["Noah leaves his bike unlocked because the parking rack is under a camera.", "Noah laisse son velo non verrouille parce que le support de stationnement est sous une camera."],
  ["Mia checks the oven less carefully because it has a timer and an auto shutoff.", "Mia verifie moins soigneusement le four parce qu il a une minuterie et un arret automatique."],
  ["Ava takes a riskier shortcut home because her phone location is shared with friends.", "Ava prend un raccourci plus risquee pour rentrer parce que la localisation de son telephone est partagee avec ses amis."],
  ["Finn drives through fog without slowing down because the car has fog lights.", "Finn conduit dans le brouillard sans ralentir parce que la voiture a des feux antibrouillard."],
  ["Mina leaves her bag at a cafe table because the app shows live location sharing.", "Mina laisse son sac sur une table de cafe parce que l application affiche un partage de position en direct."],
  ["Theo skips the seatbelt check because the car keeps reminding him with a chime.", "Theo saute le controle de ceinture parce que la voiture le lui rappelle sans cesse avec un bip."],
  ["Juno spends more freely because the banking app sends spending alerts.", "Juno depense plus librement parce que l application bancaire envoie des alertes de depense."],
  ["Iris walks in the dark without caution because her phone flashlight is stronger.", "Iris marche dans le noir sans prudence parce que la lampe de son telephone est plus puissante."],
  ["Cole takes a bigger gaming risk because the app gives a bonus shield.", "Cole prend un risque plus grand en jeu parce que l application donne un bouclier bonus."],
  ["Riley ignores the ladder footing because it is rated for more weight.", "Riley ignore l appui de l echelle parce qu elle est notee pour plus de poids."],
  ["Pia leaves the door open because the house has a security camera.", "Pia laisse la porte ouverte parce que la maison a une camera de securite."],
  ["Hugo drives faster on the highway because his car has emergency braking.", "Hugo roule plus vite sur l autoroute parce que sa voiture a un freinage d urgence."],
  ["Sam carries a hot drink without a lid because the cup has insulation.", "Sam transporte une boisson chaude sans couvercle parce que la tasse est isolee."],
  ["Jade trusts a shopping site more because the browser shows a lock icon.", "Jade fait davantage confiance a un site d achat parce que le navigateur affiche une icone de cadenas."],
  ["Owen texts while walking because his watch buzzes with obstacle alerts.", "Owen envoie des messages en marchant parce que sa montre vibre avec des alertes d obstacle."],
  ["Lea leaves sunscreen off because the weather app says the UV is moderate.", "Lea ne met pas de creme solaire parce que l application meteo dit que l indice UV est modere."],
  ["Max takes the bike lane less seriously because his lights are extra bright.", "Max prend moins au serieux la piste cyclable parce que ses lumieres sont tres brillantes."],
  ["Yara takes a sharper corner because her tires are brand new.", "Yara prend un virage plus serre parce que ses pneus sont neufs."],
  ["Dan ignores the spill because the floor has an anti-slip mat.", "Dan ignore la flaque parce que le sol a un tapis antiderapant."],
  ["Rosa leaves her laptop visible because the cafe has a privacy policy poster.", "Rosa laisse son ordinateur visible parce que le cafe a une affiche de politique de confidentialite."],
  ["Alicia opens a suspicious attachment because the email says it was scanned.", "Alicia ouvre une piece jointe suspecte parce que le courriel dit qu elle a ete scannee."],
  ["Owen takes the road at night faster because the street has better lighting.", "Owen prend la route la nuit plus vite parce que la rue est mieux eclairee."],
  ["Maya checks the recipe less because she bought a more expensive pan.", "Maya verifie moins la recette parce qu elle a achete une poele plus chere."],
  ["Ben leaves the wallet in a back pocket because his phone tracker is on.", "Ben laisse le portefeuille dans une poche arriere parce que le traceur de son telephone est active."],
  ["Nora speaks on speakerphone while crossing because the car has lane assist.", "Nora parle en haut-parleur en traversant parce que la voiture a une assistance de voie."],
  ["Eli speeds up in the rain because the car has traction control.", "Eli accelere sous la pluie parce que la voiture a un controle de traction."],
  ["Lina takes bigger risks at the arcade because the machine has a child lock.", "Lina prend plus de risques a l arcade parce que la machine a un verrou enfant."],
  ["Grant trusts the stairs more because the building added a warning sign.", "Grant fait davantage confiance aux escaliers parce que le batiment a ajoute un panneau d avertissement."],
  ["Tia drives without slowing because the new dashboard shows more alerts.", "Tia conduit sans ralentir parce que le nouveau tableau de bord affiche plus d alertes."],
  ["Noah leaves a heavy box on a chair because the chair is labeled sturdy.", "Noah laisse une boite lourde sur une chaise parce que la chaise est etiquetee solide."],
  ["Mia takes a riskier route because her smartwatch shares her location.", "Mia prend un trajet plus risquee parce que sa montre partage sa position."],
  ["Ava skips the lock because the bike now has a built-in alarm.", "Ava saute l antivol parce que le velo a maintenant une alarme integree."],
  ["Finn trusts the recipe more because the app displays a kitchen safety badge.", "Finn fait davantage confiance a la recette parce que l application affiche un badge de securite en cuisine."],
  ["Mina drives past the warning because the windshield has a heads-up display.", "Mina ignore l avertissement parce que le pare-brise a un affichage tete haute."],
  ["Theo takes a smaller seatbelt fine risk because the car chimes loudly.", "Theo prend moins au serieux le risque d une amende de ceinture parce que la voiture carillonne fort."],
  ["Juno uses a suspicious charger because the outlet has surge protection.", "Juno utilise un chargeur douteux parce que la prise a une protection contre les surtensions."],
  ["Iris leaves the window open because the smoke alarm is new.", "Iris laisse la fenetre ouverte parce que le detecteur de fumee est neuf."],
  ["Cole walks alone at night because his phone battery is full.", "Cole marche seul la nuit parce que la batterie de son telephone est pleine."],
  ["Riley drives more aggressively because the car has blind-spot alerts.", "Riley conduit plus agressivement parce que la voiture a des alertes d angle mort."],
  ["Pia handles the hot tray carelessly because the oven has a timer.", "Pia manipule le plat chaud sans prudence parce que le four a une minuterie."],
  ["Hugo trusts the helmet enough to stop checking the road.", "Hugo fait assez confiance au casque pour arreter de regarder la route."],
  ["Sam takes a bigger chance because the app says his data is backed up.", "Sam prend un risque plus grand parce que l application dit que ses donnees sont sauvegardees."],
  ["Jade leaves the fridge open because it beeps when the door stays ajar.", "Jade laisse le frigo ouvert parce qu il bippe quand la porte reste entrouverte."],
  ["Maya speeds through the parking lot because the car has parking sensors.", "Maya roule plus vite dans le parking parce que la voiture a des capteurs de stationnement."],
];
