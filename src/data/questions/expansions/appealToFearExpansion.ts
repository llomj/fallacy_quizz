...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ["A pop-up says your family photos will vanish in ten minutes unless you install this security app, so Jules installs it immediately.", "Une fenêtre surgissante dit que vos photos de famille disparaîtront dans dix minutes si vous n'installez pas cette application de sécurité, alors Jules l'installe immédiatement."],
  ["The email warns that skipping this webinar will ruin your career by Friday, and Mia signs up in a panic.", "Le courriel avertit que manquer ce webinaire ruinera votre carrière d'ici vendredi, et Mia s'inscrit dans la panique."],
