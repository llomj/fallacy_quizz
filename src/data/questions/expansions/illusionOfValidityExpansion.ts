...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ...
  ['Maya trusts the test result because it is displayed in a polished layout.', "Maya fait confiance au resultat du test parce qu il est affiche dans une mise en page soignee."],
  ['Leo believes the plan is right because the summary page looks official.', "Leo croit que le plan est juste parce que la page de resume a l air officielle."],
  ['Nina assumes a neat chart proves the forecast is correct.', "Nina suppose qu un graphique net prouve que la prevision est correcte."],
  ['Owen thinks a technical-sounding model must be accurate.', "Owen pense qu un modele au son technique doit etre exact."],
  ['Priya trusts the diagnosis because the app shows a precise percentage.', "Priya fait confiance au diagnostic parce que l application affiche un pourcentage precis."],
  ['Ben believes a confident speaker is always reliable when the slide deck is clean.', "Ben croit qu un orateur sur de lui est toujours fiable quand le diaporama est propre."],
  ['Tara assumes the ranking is valid because the spreadsheet uses many colors.', "Tara suppose que le classement est valable parce que le tableur utilise beaucoup de couleurs."],
  ['Kai thinks the forecast is right because the graph has a bold title and sharp lines.', "Kai pense que la prevision est correcte parce que le graphique a un titre en gras et des lignes nettes."],
  ['Jules trusts the hiring score because it comes from a polished dashboard.', "Jules fait confiance au score de recrutement parce qu il vient d un tableau de bord soigné."],
  ['Ava believes the recommendation is solid because the report feels final.', "Ava croit que la recommandation est solide parce que le rapport semble definitif."],
  ['Noah assumes the stock tip is true because the analyst sounds certain.', "Noah suppose que le conseil boursier est vrai parce que l analyste a l air certain."],
  ['Mina trusts a forecast because the app looks premium and expensive.', "Mina fait confiance a une prevision parce que l application a l air premium et chere."],
  ['Eli thinks a clean interface means the diagnosis is accurate.', "Eli pense qu une interface propre veut dire que le diagnostic est exact."],
  ['Rina assumes the prediction is good because the chart is neat and colorful.', "Rina suppose que la prevision est bonne parce que le graphique est net et colore."],
  ['Hugo believes the budget projection is sound because the numbers line up perfectly.', "Hugo croit que la projection budgetaire est solide parce que les chiffres s alignent parfaitement."],
  ['Lina trusts the course recommendation because the advisor spoke with authority.', "Lina fait confiance a la recommandation de cours parce que le conseiller parlait avec autorite."],
  ['Grant thinks the risk score is meaningful because it appears in a bold badge.', "Grant pense que le score de risque a du sens parce qu il apparait dans un badge en gras."],
  ['Zoe believes the weather prediction because the dashboard is full of polished icons.', "Zoe croit a la prevision meteo parce que le tableau de bord est plein d icones soignées."],
  ['Milo assumes the report is correct because the wording sounds scientific.', "Milo suppose que le rapport est correct parce que la formulation semble scientifique."],
  ['Theo trusts the tutor because the answer was presented with exact numbers.', "Theo fait confiance au tuteur parce que la reponse a ete presentee avec des nombres precis."],
  ['Pia thinks the score is accurate because it is shown in a clean, modern design.', "Pia pense que le score est exact parce qu il est affiche dans un design propre et moderne."],
  ['Finn assumes the reviewer is right because the review reads smoothly.', "Finn suppose que le critique a raison parce que l avis se lit bien."],
  ['Maya believes the recommendation because the app uses charts and jargon.', "Maya croit a la recommandation parce que l application utilise des graphiques et du jargon."],
  ['Sam trusts the forecast because the presenter sounded calm and professional.', "Sam fait confiance a la prevision parce que le presentateur semblait calme et professionnel."],
  ['Juno thinks the diagnosis is valid because the result page looks official.', "Juno pense que le diagnostic est valable parce que la page de resultat a l air officielle."],
  ['Iris believes the prediction is right because it matches her favorite outcome.', "Iris croit que la prediction est juste parce qu elle correspond a son resultat prefere."],
  ['Cole assumes the training score is true because the report is neatly formatted.', "Cole suppose que le score de formation est vrai parce que le rapport est bien mis en forme."],
  ['Nora trusts the sales projection because the spreadsheet has a polished color scheme.', "Nora fait confiance a la projection des ventes parce que la feuille de calcul a une palette soignée."],
  ['Ari thinks the medical estimate must be correct because the app shows two decimal places.', "Ari pense que l estimation medicale doit etre correcte parce que l application affiche deux decimales."],
  ['Rita assumes the forecast is reliable because the chart looks expensive.', "Rita suppose que la prevision est fiable parce que le graphique a l air cher."],
  ['Tia believes the ranking is accurate because the table looks technical and official.', "Tia croit que le classement est exact parce que le tableau a l air technique et officiel."],
  ['Oli trusts the plan because the summary is short, tidy, and confident.', "Oli fait confiance au plan parce que le resume est court, soigné et assure."],
];
