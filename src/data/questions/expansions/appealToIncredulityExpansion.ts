...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ...
  ["The neighborhood rumor must be true because it sounds too weird to invent.", "La rumeur du quartier doit être vraie parce qu elle semble trop étrange pour être inventée."],
  ["Mina says the refund policy is fake because she cannot picture a store being that generous.", "Mina dit que la politique de remboursement est fausse parce qu elle n arrive pas à imaginer qu un magasin soit si généreux."],
  ["Theo rejects the science demo because he cannot imagine balloons doing that.", "Theo rejette la démonstration scientifique parce qu il n arrive pas à imaginer des ballons faire ça."],
  ["A customer says the discount must be fake because it looks too good to be true.", "Une cliente dit que la réduction doit être fausse parce qu elle semble trop belle pour être vraie."],
  ["Nina dismisses the weather report because the fog turning into rain feels impossible to her.", "Nina rejette le bulletin météo parce que le brouillard qui devient pluie lui paraît impossible."],
  ["Omar thinks the router cannot be fixed because he cannot picture the steps.", "Omar pense que le routeur ne peut pas être réparé parce qu il n arrive pas à imaginer les étapes."],
  ["The teacher rejects the math trick because it looks weird at first glance.", "L enseignant rejette l astuce de maths parce qu elle a l air bizarre au premier coup d œil."],
  ["A friend says the schedule must be wrong because nobody would plan it that way.", "Un ami dit que l horaire doit être faux parce que personne ne le planifierait ainsi."],
  ["Leah refuses to believe the story because she cannot see how it could happen.", "Leah refuse de croire l histoire parce qu elle ne voit pas comment cela pourrait arriver."],
  ["The team calls the result impossible because it is hard to wrap their heads around.", "L équipe dit que le résultat est impossible parce qu il est difficile à comprendre."],
  ["Ben ignores the map because the route looks too simple to be accurate.", "Ben ignore la carte parce que l itinéraire a l air trop simple pour être exact."],
  ...
  ["Jules says the answer is false because it sounds like a trick.", "Jules dit que la réponse est fausse parce qu elle ressemble à une astuce."],
  ["Ava rejects the schedule because it seems too neat for real life.", "Ava rejette l horaire parce qu il paraît trop bien rangé pour la vraie vie."],
  [`Maya says the plan is fake because she cannot imagine her boss agreeing to it.`, `Maya dit que le plan est faux parce qu elle n arrive pas à imaginer son patron y consentir.`],
  [`Leo rejects the tip because it sounds too simple to matter.`, `Leo rejette le conseil parce qu il semble trop simple pour compter.`],
  [`Nina says the report cannot be accurate because the conclusion feels backwards.`, `Nina dit que le rapport ne peut pas être exact parce que la conclusion lui parait à l envers.`],
  [`Owen dismisses the repair guide because he cannot picture the steps working.`, `Owen rejette le guide de réparation parce qu il n arrive pas à imaginer les étapes fonctionner.`],
  [`Priya says the discount must be fake because it looks too generous.`, `Priya dit que la réduction doit être fausse parce qu elle a l air trop généreuse.`],
  [`Ben thinks the route is impossible because it seems odd on the map.`, `Ben pense que l itinéraire est impossible parce qu il a l air bizarre sur la carte.`],
  [`Tara says the weather alert is wrong because fog turning into rain feels weird to her.`, `Tara dit que l alerte météo est fausse parce que le brouillard devenant pluie lui semble bizarre.`],
  [`Kai rejects the recipe because the healthy version looks too plain.`, `Kai rejette la recette parce que la version saine a l air trop simple.`],
  [`Jules says the refund policy cannot be real because it sounds too generous.`, `Jules dit que la politique de remboursement ne peut pas être réelle parce qu elle semble trop généreuse.`],
  [`Ava calls the new schedule fake because it is too neat for her taste.`, `Ava appelle le nouvel horaire faux parce qu il est trop bien rangé à son goût.`],
  [`Noah says the science result is nonsense because he cannot wrap his head around it.`, `Noah dit que le résultat scientifique est absurde parce qu il n arrive pas à le comprendre.`],
  [`Mina rejects the updated map because it does not fit the streets she knows.`, `Mina rejette la carte mise à jour parce qu elle ne correspond pas aux rues qu elle connaît.`],
  [`Eli says the story is false because the ending is too surprising.`, `Eli dit que l histoire est fausse parce que la fin est trop surprenante.`],
  [`Rina says the new software cannot help because it does not look impressive.`, `Rina dit que le nouveau logiciel ne peut pas aider parce qu il n a pas l air impressionnant.`],
  [`Hugo refuses the travel tip because he cannot picture the route working.`, `Hugo refuse le conseil de voyage parce qu il n arrive pas à imaginer l itinéraire fonctionner.`],
  [`Lina says the schedule is wrong because nobody would plan it that way.`, `Lina dit que l horaire est faux parce que personne ne le planifierait ainsi.`],
  [`Grant says the claim is impossible because he has never seen anything like it.`, `Grant dit que l affirmation est impossible parce qu il n a jamais vu quelque chose de similaire.`],
  [`Zoe rejects the budget plan because the numbers do not feel intuitive.`, `Zoe rejette le plan budgétaire parce que les chiffres ne lui paraissent pas intuitifs.`],
  [`Milo says the app update is fake because it sounds too tidy.`, `Milo dit que la mise à jour de l application est fausse parce qu elle semble trop soignée.`],
  [`Theo says the school rule cannot work because it feels too different from the old one.`, `Theo dit que la règle scolaire ne peut pas marcher parce qu elle semble trop différente de l ancienne.`],
  [`Pia dismisses the snack review because the praise sounds unbelievable.`, `Pia rejette l avis sur la collation parce que les éloges semblent incroyables.`],
  [`Finn says the route change is impossible because he cannot see how it saves time.`, `Finn dit que le changement d itinéraire est impossible parce qu il ne voit pas comment il ferait gagner du temps.`],
  [`Maya says the clinic advice is wrong because it feels too strange to follow.`, `Maya dit que le conseil de la clinique est faux parce qu il paraît trop étrange à suivre.`],
  [`Sam says the product must be fake because the ad is too polished.`, `Sam dit que le produit doit être faux parce que la pub est trop bien faite.`],
  [`Juno says the answer is wrong because it sounds like a trick.`, `Juno dit que la réponse est fausse parce qu elle ressemble à une astuce.`],
  [`Iris rejects the new habit because she cannot imagine doing it after work.`, `Iris rejette la nouvelle habitude parce qu elle n arrive pas à s imaginer la faire apres le travail.`],
  [`Cole says the warranty cannot be real because the terms are easy to understand.`, `Cole dit que la garantie ne peut pas être réelle parce que les conditions sont faciles à comprendre.`],
  [`Nora says the route advice is false because it does not match her gut feeling.`, `Nora dit que le conseil d itinéraire est faux parce qu il ne correspond pas à son intuition.`],
  [`Ari dismisses the bird report because he has never seen that many birds.`, `Ari rejette le rapport sur les oiseaux parce qu il n a jamais vu autant d oiseaux.`],
  [`Rita says the update cannot help because it seems too calm for a real solution.`, `Rita dit que la mise à jour ne peut pas aider parce qu elle semble trop calme pour être une vraie solution.`],
  [`Tia says the support guide is fake because the steps look ordinary.`, `Tia dit que le guide d aide est faux parce que les étapes ont l air ordinaires.`],
  [`Oli rejects the scholarship because it sounds too good to be true.`, `Oli rejette la bourse parce qu elle semble trop belle pour être vraie.`],
  [`Lara says the cooking tip is nonsense because she cannot picture it working.`, `Lara dit que le conseil de cuisine est absurde parce qu elle n arrive pas à l imaginer fonctionner.`],
  [`Ben says the team plan is wrong because it looks too clean.`, `Ben dit que le plan de l équipe est faux parce qu il a l air trop net.`],
  [`Mina rejects the neighborhood alert because it feels exaggerated.`, `Mina rejette l alerte du quartier parce qu elle lui semble exagérée.`],
  [`Drew says the new app cannot be useful because it is not flashy.`, `Drew dit que la nouvelle application ne peut pas être utile parce qu elle n est pas tape-à-l'œil.`],
  [`Jade says the clinic recommendation is false because it sounds backwards.`, `Jade dit que la recommandation de la clinique est fausse parce qu elle semble à l envers.`],
  [`Owen dismisses the easy math trick because it seems too simple to work.`, `Owen rejette l astuce de maths parce qu elle semble trop simple pour marcher.`],
  [`Mila says the passenger update is fake because the wording sounds too neat.`, `Mila dit que la mise à jour pour les passagers est fausse parce que la formulation semble trop soignée.`],
  [`Evan says the map is wrong because he cannot see how the streets line up.`, `Evan dit que la carte est fausse parce qu il ne voit pas comment les rues s alignent.`],
  ["Maya says the new recycling rule cannot work because it feels too tidy for real life.", "Maya dit que la nouvelle règle de recyclage ne peut pas marcher parce qu elle semble trop bien rangée pour la vraie vie."],
  ["Leo rejects the repair estimate because he cannot imagine a toaster costing that much.", "Leo rejette le devis de réparation parce qu il n arrive pas à imaginer qu un grille-pain puisse coûter autant."],
  ["Nina says the travel itinerary is fake because the connections look too smooth.", "Nina dit que l itinéraire de voyage est faux parce que les correspondances ont l air trop fluides."],
  ["Owen calls the science demo impossible because balloons doing that seems odd to him.", "Owen dit que la démonstration scientifique est impossible parce que des ballons faisant ça lui paraît étrange."],
  ["Priya dismisses the refund policy because it sounds too generous to be true.", "Priya rejette la politique de remboursement parce qu elle semble trop généreuse pour être vraie."],
  ["Ben says the new schedule must be wrong because nobody would plan a week like that.", "Ben dit que le nouvel horaire doit être faux parce que personne ne planifierait une semaine comme ça."],
  ["Tara rejects the cleaner recipe because it looks too plain to be useful.", "Tara rejette la recette plus simple parce qu elle a l air trop ordinaire pour être utile."],
  ["Kai says the app update is fake because the explanation sounds too neat.", "Kai dit que la mise à jour de l application est fausse parce que l explication semble trop propre."],
  ["Jules doubts the clinic advice because he cannot picture it helping after lunch.", "Jules doute du conseil de la clinique parce qu il n arrive pas à l imaginer aider après le déjeuner."],
  ["Ava says the discount must be made up because it feels unbelievable.", "Ava dit que la réduction doit être inventée parce qu elle paraît incroyable."],
  ["Noah dismisses the weather warning because fog turning into rain sounds weird.", "Noah rejette l avertissement météo parce que le brouillard qui devient pluie lui paraît bizarre."],
  ["Mina says the map is wrong because the streets do not line up the way she expects.", "Mina dit que la carte est fausse parce que les rues ne s alignent pas comme elle s y attend."],
  ["Eli refuses the budget plan because it looks too calm for a real solution.", "Eli refuse le plan budgétaire parce qu il semble trop calme pour être une vraie solution."],
  ["Rina says the scholarship is fake because it sounds too good to be true.", "Rina dit que la bourse est fausse parce qu elle semble trop belle pour être vraie."],
  ["Hugo calls the report impossible because he cannot wrap his head around the result.", "Hugo dit que le rapport est impossible parce qu il n arrive pas à comprendre le résultat."],
  ["Lina rejects the repair guide because the steps seem too ordinary to work.", "Lina rejette le guide de réparation parce que les étapes semblent trop ordinaires pour fonctionner."],
  ["Grant says the new rule cannot work because it feels too different from the old one.", "Grant dit que la nouvelle règle ne peut pas marcher parce qu elle semble trop différente de l ancienne."],
  ["Zoe says the email cannot be real because it sounds too polished.", "Zoe dit que le courriel ne peut pas être réel parce qu il semble trop soigné."],
  ["Milo rejects the route change because he cannot imagine it saving time.", "Milo rejette le changement d itinéraire parce qu il n arrive pas à imaginer qu il fasse gagner du temps."],
  ["Theo says the answer must be wrong because it sounds like a trick.", "Theo dit que la réponse doit être fausse parce qu elle ressemble à une astuce."],
  ["Pia doubts the support article because it is too easy to understand.", "Pia doute de l article d aide parce qu il est trop facile à comprendre."],
  ["Finn rejects the health tip because he cannot see how it would taste good.", "Finn rejette le conseil santé parce qu il ne voit pas comment cela pourrait avoir bon goût."],
  ["Maya says the school rule is false because nobody would choose such a rule.", "Maya dit que la règle scolaire est fausse parce que personne ne choisirait une telle règle."],
  ["Sam dismisses the promo because it seems too neat to be honest.", "Sam rejette la promotion parce qu elle semble trop propre pour être honnête."],
  ["Juno says the science result is nonsense because it does not fit her intuition.", "Juno dit que le résultat scientifique est absurde parce qu il ne correspond pas à son intuition."],
  ["Iris rejects the cleaner route because it looks too plain on the map.", "Iris rejette la route la plus simple parce qu elle a l air trop ordinaire sur la carte."],
  ["Cole says the new software cannot help because it does not look impressive.", "Cole dit que le nouveau logiciel ne peut pas aider parce qu il n a pas l air impressionnant."],
  ["Nora dismisses the story because the ending is too surprising.", "Nora rejette l histoire parce que la fin est trop surprenante."],
  ["Ari says the meeting plan is fake because nobody would arrange it that way.", "Ari dit que le plan de réunion est faux parce que personne ne l organiserait ainsi."],
  ["Rita rejects the warning because it sounds more serious than she thinks it should.", "Rita rejette l avertissement parce qu il semble plus sérieux qu elle ne le pense."],
  ["Tia says the cooking advice cannot be right because she cannot imagine it being tasty.", "Tia dit que le conseil de cuisine ne peut pas être juste parce qu elle n arrive pas à l imaginer bon."],
  ["Oli calls the refund promise fake because it feels too convenient.", "Oli dit que la promesse de remboursement est fausse parce qu elle paraît trop commode."],
  ["Lara says the event cannot be popular because it sounds too calm.", "Lara dit que l événement ne peut pas être populaire parce qu il semble trop calme."],
  ["Ben rejects the movie review because the praise sounds unbelievable.", "Ben rejette la critique du film parce que les éloges semblent incroyables."],
  ["Mina says the app is fake because the design looks too clean.", "Mina dit que l application est fausse parce que le design a l air trop propre."],
  ["Drew doubts the train update because the wording sounds too neat.", "Drew doute de la mise à jour du train parce que la formulation semble trop soignée."],
  ["Jade says the shortcut is impossible because she cannot picture it working.", "Jade dit que le raccourci est impossible parce qu elle n arrive pas à l imaginer fonctionner."],
  ["Owen rejects the family recipe because it looks too basic.", "Owen rejette la recette de famille parce qu elle a l air trop basique."],
  ["Priya says the plan is false because it feels backwards.", "Priya dit que le plan est faux parce qu il lui paraît à l envers."],
  ["Evan says the poster is wrong because it seems too strange to follow.", "Evan dit que l affiche est fausse parce qu elle semble trop étrange à suivre."],
  ["Kira rejects the menu because the healthy option looks too plain.", "Kira rejette le menu parce que l option saine a l air trop simple."],
  ["Hana says the link cannot be safe because it sounds like a trap.", "Hana dit que le lien ne peut pas être sûr parce qu il ressemble à un piège."],
  ["Leo says the budget forecast is impossible because the numbers do not feel intuitive.", "Leo dit que la prévision budgétaire est impossible parce que les chiffres ne lui paraissent pas intuitifs."],
  ["Nina dismisses the map because the route looks too awkward to be real.", "Nina rejette la carte parce que l itinéraire a l air trop maladroit pour être réel."],
  ["Omar says the new tool is fake because it seems too simple to matter.", "Omar dit que le nouvel outil est faux parce qu il semble trop simple pour compter."],
  ["Lea refuses the advice because she cannot imagine using it at work.", "Lea refuse le conseil parce qu elle n arrive pas à imaginer l utiliser au travail."],
  ["Noah says the claim is false because he has never seen anything like it.", "Noah dit que l affirmation est fausse parce qu il n a jamais vu quelque chose de semblable."],
  ["Mia rejects the product because the ad is too polished.", "Mia rejette le produit parce que la pub est trop bien faite."],
  ["Hugo says the answer must be wrong because the logic feels too neat.", "Hugo dit que la réponse doit être fausse parce que la logique lui paraît trop nette."],
  ["Ava doubts the school notice because the wording sounds too calm for bad news.", "Ava doute de l avis scolaire parce que le ton paraît trop calme pour une mauvaise nouvelle."],
];
