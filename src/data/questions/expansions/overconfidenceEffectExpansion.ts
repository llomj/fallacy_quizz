...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ...
  ['Ari says he can fix the leaky faucet in one try because he watched a repair video last night.', 'Ari dit qu il peut réparer le robinet qui fuit en une seule tentative parce qu il a regardé une vidéo de réparation hier soir.'],
  ['Mina says she can ace the presentation because she feels confident after practicing once in her room.', 'Mina dit qu elle peut réussir la présentation parce qu elle se sent confiante après une seule répétition dans sa chambre.'],
  ['Leo says he can negotiate the contract alone because he once got a discount at a store.', 'Leo dit qu il peut négocier le contrat seul parce qu il a déjà obtenu une réduction dans un magasin.'],
  ['Nora says she can cook for twelve people because she made dinner for three friends last month.', 'Nora dit qu elle peut cuisiner pour douze personnes parce qu elle a préparé le dîner pour trois amis le mois dernier.'],
  ['Ben says he can guess the exam answers because the questions will probably be easy.', 'Ben dit qu il peut deviner les réponses de l examen parce que les questions seront probablement faciles.'],
  ['Priya says she can design the flyer by eye because she knows what looks good.', 'Priya dit qu elle peut concevoir le flyer à l œil parce qu elle sait ce qui est joli.'],
  ['Omar says he can lead the hike because he walked one trail last summer.', 'Omar dit qu il peut diriger la randonnée parce qu il a marché sur un sentier l été dernier.'],
  ['Lina says she can translate the brochure without help because she understood one sentence in it.', 'Lina dit qu elle peut traduire la brochure sans aide parce qu elle a compris une phrase dedans.'],
  ['Theo says he can win the baking contest because his cupcakes were popular once.', 'Theo dit qu il peut gagner le concours de pâtisserie parce que ses cupcakes ont déjà eu du succès une fois.'],
  ['Juno says she can finish the budget in an hour because she is naturally organized.', 'Juno dit qu elle peut terminer le budget en une heure parce qu elle est naturellement organisée.'],
  ['Iris says she can spot the fake photo instantly because she has a good eye.', 'Iris dit qu elle peut repérer la fausse photo instantanément parce qu elle a un bon œil.'],
  ['Cole says he can teach the game to new players because he understands the rules.', 'Cole dit qu il peut apprendre le jeu aux nouveaux joueurs parce qu il comprend les règles.'],
  ['Riley says he can estimate the renovation cost because he has watched home shows.', 'Riley dit qu il peut estimer le coût de la rénovation parce qu il a regardé des émissions de rénovation.'],
  ['Pia says she can handle the customer call because she has never been nervous on the phone.', 'Pia dit qu elle peut gérer l appel client parce qu elle n a jamais été nerveuse au téléphone.'],
  ['Hugo says he can predict the team lineup because he follows sports closely.', 'Hugo dit qu il peut prédire la composition de l équipe parce qu il suit le sport de près.'],
  ['Sam says he can learn the new app in minutes because he is good with gadgets.', 'Sam dit qu il peut apprendre la nouvelle application en quelques minutes parce qu il est à l aise avec les gadgets.'],
  ['Jade says she can host the party alone because the invitations are already sent.', 'Jade dit qu elle peut organiser la fête seule parce que les invitations sont déjà envoyées.'],
  ['Maya says she can solve the spreadsheet problem because numbers are easy for her.', 'Maya dit qu elle peut résoudre le problème du tableur parce que les nombres sont faciles pour elle.'],
  ['Finn says he can pick the best route without maps because he has a strong sense of direction.', 'Finn dit qu il peut choisir le meilleur itinéraire sans carte parce qu il a un bon sens de l orientation.'],
  ['Tia says she can train the puppy in a week because it already likes her.', 'Tia dit qu elle peut dresser le chiot en une semaine parce qu il l aime déjà bien.'],
  ['Noah says he can write the report fast because he knows the topic from memory.', 'Noah dit qu il peut rédiger le rapport rapidement parce qu il connaît le sujet par cœur.'],
  ['Ava says she can manage the whole event because she once organized a small picnic.', 'Ava dit qu elle peut gérer tout l événement parce qu elle a déjà organisé un petit pique-nique.'],
  ['Grant says he can estimate the repair time because the broken part looks simple.', 'Grant dit qu il peut estimer le temps de réparation parce que la pièce cassée a l air simple.'],
  ['Mina says she can beat the puzzle game because she solved one hard level already.', 'Mina dit qu elle peut battre le jeu de puzzle parce qu elle a déjà réussi un niveau difficile.'],
  ['Eli says he can grill for twenty people because he knows how to cook burgers.', 'Eli dit qu il peut cuisiner au grill pour vingt personnes parce qu il sait faire des burgers.'],
  ['Zoe says she can judge the whole art contest because she likes colorful pieces.', 'Zoé dit qu elle peut juger tout le concours d art parce qu elle aime les œuvres colorées.'],
  ['Kai says he can repair the bike chain because he tightened one screw before.', 'Kai dit qu il peut réparer la chaîne du vélo parce qu il a déjà serré une vis.'],
  ['Lina says she can finish the project tonight because she works best under pressure.', 'Lina dit qu elle peut terminer le projet ce soir parce qu elle travaille le mieux sous pression.'],
  ['Omar says he can forecast the weather because he has been right before.', 'Omar dit qu il peut prévoir la météo parce qu il avait déjà raison une fois.'],
  ['Nina says she can lead the workshop because she likes explaining things.', 'Nina dit qu elle peut diriger l atelier parce qu elle aime expliquer les choses.'],
  ['Ben says he can solve the password problem because he is good at patterns.', 'Ben dit qu il peut résoudre le problème de mot de passe parce qu il est fort pour les motifs.'],
  ['Mia says she can finish the move alone because she carried a few boxes last year.', 'Mia dit qu elle peut finir le déménagement seule parce qu elle a porté quelques cartons l an dernier.'],
  ['Theo says he can buy the right stock because he once made a lucky choice.', 'Theo dit qu il peut acheter la bonne action parce qu il a déjà fait un choix chanceux.'],
  ['Jade says she can run the quiz night because she knows lots of trivia.', 'Jade dit qu elle peut animer la soirée quiz parce qu elle connaît beaucoup d anecdotes.'],
  ['Hugo says he can fix the Wi-Fi because he knows where the router is.', 'Hugo dit qu il peut réparer le Wi-Fi parce qu il sait où se trouve le routeur.'],
  ['Rina says she can negotiate the rent because she once asked for a free refill.', 'Rina dit qu elle peut négocier le loyer parce qu elle a déjà demandé un remplissage gratuit.'],
  ['Grant says he can review the whole contract because he read the first page carefully.', 'Grant dit qu il peut relire tout le contrat parce qu il a lu la première page attentivement.'],
  ['Tia says she can handle the charity auction because speaking loudly is easy.', 'Tia dit qu elle peut gérer la vente aux enchères car parler fort est facile.'],
  ['Finn says he can pick the safest road because he has driven there before.', 'Finn dit qu il peut choisir la route la plus sûre parce qu il y a déjà conduit.'],
  ['Pia says she can finish the lesson plan because she already knows the basics.', 'Pia dit qu elle peut terminer le plan de cours parce qu elle connaît déjà les bases.'],
  ['Ari says he can fix the printer because he has changed paper before.', 'Ari dit qu il peut réparer l imprimante parce qu il a déjà changé du papier.'],
  ['Lina says she can organize the whole cabinet because she is good at lists.', 'Lina dit qu elle peut organiser toute l armoire parce qu elle est bonne avec les listes.'],
  ['Cole says he can teach the new software because he clicked through it once.', 'Cole dit qu il peut enseigner le nouveau logiciel parce qu il l a parcouru une fois.'],
  ['Maya says she can lead the team meeting because she is usually right about small things.', 'Maya dit qu elle peut diriger la réunion d équipe parce qu elle a souvent raison sur les petites choses.'],
  ['Noah says he can handle the plumbing because the sink is "only a little broken."', 'Noah dit qu il peut gérer la plomberie parce que l évier est "à peine cassé".'],
  ['Sara says she can create the ad campaign because she knows what she likes to see online.', 'Sara dit qu elle peut créer la campagne publicitaire parce qu elle sait ce qu elle aime voir en ligne.'],
  ['Theo says he can finish the marathon plan because he is determined, not because he has trained enough.', 'Theo dit qu il peut terminer le plan marathon parce qu il est déterminé, pas parce qu il s est assez entraîné.'],
  ['Juno says she can run the meeting because she once gave a great speech.', 'Juno dit qu elle peut diriger la réunion parce qu elle a déjà fait un excellent discours.'],
  ['Iris says she can estimate the repairs because the house looks "mostly fine."', 'Iris dit qu elle peut estimer les réparations parce que la maison a l air "à peu près bien".'],
];
