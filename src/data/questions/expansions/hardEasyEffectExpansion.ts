...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ...
  ['Nora changes one spreadsheet cell and thinks she can run finance, but a full annual report makes her say accounting is impossible.', "Nora change une seule cellule du tableur et pense qu elle peut gerer les finances, mais un rapport annuel complet la fait dire que la comptabilite est impossible."],
  ['Ben sends one polished message and assumes public relations will be easy, while a crisis plan makes him back away from the whole field.', "Ben envoie un message soigne et suppose que les relations publiques seront faciles, alors qu un plan de crise le fait reculer devant tout le domaine."],
  ['Priya labels a few folders and says she could organize a library, but a catalog system makes her think the task is far too technical.', "Priya etiquete quelques dossiers et dit qu elle pourrait organiser une bibliotheque, mais un systeme de catalogage lui fait penser que la tache est bien trop technique."],
  ['Theo sets one reminder and says he could manage everyone’s calendar, yet a conference schedule makes him claim planning is beyond him.', "Theo met un rappel et dit qu il pourrait gerer le calendrier de tout le monde, mais un programme de conference le fait affirmer que l organisation le depasse."],
  ['Ava edits one sentence and decides she could be an editor, while a long manuscript makes her say writing is too hard.', "Ava corrige une phrase et decide qu elle pourrait etre redactrice, alors qu un long manuscrit la fait dire que l ecriture est trop difficile."],
  ['Omar answers one practice question and says he can handle the whole exam, but a second harder page makes him panic.', "Omar repond a une question d entrainement et dit qu il peut gerer tout l examen, mais une deuxieme page plus difficile le fait paniquer."],
  ['Lina folds one brochure and says she could run a marketing department, yet a full campaign brief makes her think the job is impossible.', "Lina plie une brochure et dit qu elle pourrait gerer un departement marketing, mais un dossier de campagne complet lui fait penser que le travail est impossible."],
  ['Jules builds one simple shelf and concludes construction is easy, but a house blueprint makes him decide the whole trade is beyond him.', "Jules monte une etagere simple et conclut que la construction est facile, mais un plan de maison le fait decider que tout le metier le depasse."],
  ['Mina formats one slide and says she can do a corporate presentation, then a dense deck makes her insist the whole thing is too hard.', "Mina met en forme une diapositive et dit qu elle peut faire une presentation d entreprise, puis un diaporama dense la fait insister sur le fait que tout cela est trop difficile."],
  ['Eli changes one setting and thinks he can fix any phone, but a full troubleshooting guide makes him say the device is hopeless.', "Eli change un reglage et pense qu il peut reparer n importe quel telephone, mais un guide de depannage complet le fait dire que l appareil est sans espoir."],
];
