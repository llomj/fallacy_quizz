...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ...
  ['Ari assumes his coworkers want the same loud music he likes during lunch breaks.', 'Ari suppose que ses collègues veulent la meme musique forte qu il aime pendant les pauses déjeuner.'],
  ['Mina thinks her friend will want the same tiny apartment setup because she is happy in small spaces.', 'Mina pense que son amie voudra le meme petit appartement parce qu elle est heureuse dans les petits espaces.'],
  ['Leo assumes everyone wants to answer emails immediately because he feels better when his inbox is empty.', 'Leo suppose que tout le monde veut répondre aux courriels immédiatement parce qu il se sent mieux quand sa boîte de réception est vide.'],
  ['Nora picks the same lunch as her sister and assumes her sister also wants the exact same thing every day.', 'Nora choisit le meme déjeuner que sa soeur et suppose que sa soeur veut elle aussi exactement la meme chose tous les jours.'],
  ['Ben says his friend must enjoy long road trips because he does not mind sitting still for hours.', 'Ben dit que son ami doit aimer les longs voyages en voiture parce que lui ne voit pas d inconvénient à rester assis pendant des heures.'],
  ['Priya assumes her neighbor wants bright holiday lights because they make her feel cheerful.', 'Priya suppose que son voisin veut des lumières de fete vives parce qu elles la rendent joyeuse.'],
  ['Omar thinks the whole office wants spicy takeout because he always craves heat at lunch.', 'Omar pense que tout le bureau veut des plats épicés à emporter parce qu il a toujours envie de piquant au déjeuner.'],
  ['Lina believes her classmate wants a detailed study guide because she personally likes having every note written out.', 'Lina croit que sa camarade veut un guide d étude détaillé parce qu elle aime elle-meme avoir chaque note écrite.'],
  ['Theo assumes his family wants the same quiet Sunday he wants, with no visitors at all.', 'Theo suppose que sa famille veut le meme dimanche calme que lui, sans aucune visite.'],
  ['Juno thinks the team will appreciate extra slides because she likes seeing every detail in a presentation.', 'Juno pense que l équipe appréciera plus de diapositives parce qu elle aime voir chaque détail dans une présentation.'],
  ['Iris buys the same tea for everyone and assumes they all like strong herbal flavors.', 'Iris achète le meme thé pour tout le monde et suppose qu ils aiment tous les saveurs herbacées fortes.'],
  ['Cole says the class should use his favorite app because he feels annoyed by anything slower.', 'Cole dit que la classe devrait utiliser son application préférée parce qu il est agacé par tout ce qui est plus lent.'],
  ['Riley assumes the client wants a formal email because he likes professional tone in every message.', 'Riley suppose que le client veut un courriel formel parce qu il aime un ton professionnel dans chaque message.'],
  ['Pia thinks her friend will love a museum date because she enjoys quiet outings herself.', 'Pia pense que son amie adorera un rendez-vous au musée parce qu elle aime elle-même les sorties calmes.'],
  ['Hugo says the whole group wants the same dessert because he always orders chocolate.', 'Hugo dit que tout le groupe veut le meme dessert parce qu il commande toujours du chocolat.'],
  ['Sam assumes coworkers do not mind late texts because he never checks his phone after dinner.', 'Sam suppose que les collègues ne sont pas dérangés par les messages tardifs parce qu il ne consulte jamais son téléphone après le dîner.'],
  ['Maya believes everyone wants the same fancy water bottle because she notices the difference immediately.', 'Maya croit que tout le monde veut la meme gourde chic parce qu elle remarque la différence immédiatement.'],
  ['Finn chooses a giant birthday cake and assumes the guests want leftovers like he does.', 'Finn choisit un énorme gâteau d anniversaire et suppose que les invités veulent des restes comme lui.'],
  ['Lea says her neighbor must enjoy quiet music because she likes soft background sound.', 'Léa dit que sa voisine doit aimer la musique calme parce qu elle aime le fond sonore doux.'],
  ['Grant assumes the whole team wants a standing meeting because he feels more awake while standing.', 'Grant suppose que toute l équipe veut une réunion debout parce qu il se sent plus éveillé en restant debout.'],
  ['Tia thinks everyone wants the same phone brightness because she prefers dim screens.', 'Tia pense que tout le monde veut la meme luminosité de téléphone parce qu elle préfère les écrans tamisés.'],
  ['Noah believes his brother wants the same weekend of errands because he does not mind chores.', 'Noah croit que son frère veut le meme week-end de courses parce qu il ne craint pas les corvées.'],
  ['Ava assumes the party should be formal because she likes dressing up.', 'Ava suppose que la fete devrait être formelle parce qu elle aime s habiller chic.'],
  ['Nina says her roommate must want a clean desk because she cannot focus in clutter.', 'Nina dit que sa colocataire doit vouloir un bureau propre parce qu elle ne peut pas se concentrer dans le désordre.'],
  ['Eli assumes the whole family wants the same brand of cereal because he likes that brand.', 'Eli suppose que toute la famille veut la meme marque de céréales parce qu il aime cette marque.'],
  ['Lina thinks the staff wants the same break schedule because she likes predictable timing.', 'Lina pense que le personnel veut le meme horaire de pause parce qu elle aime un timing prévisible.'],
  ['Omar says his friend will love a long documentary because he likes learning by watching.', 'Omar dit que son ami adorera un long documentaire parce qu il aime apprendre en regardant.'],
  ['Mina assumes the office wants the thermostat set low because she runs hot.', 'Mina suppose que le bureau veut le thermostat réglé bas parce qu elle a toujours chaud.'],
  ['Theo chooses a silent group chat and expects everyone to appreciate the lack of emojis.', 'Theo choisit un groupe de discussion silencieux et s attend à ce que tout le monde apprécie l absence d emojis.'],
  ['Jade thinks the whole neighborhood wants the same park bench because she likes that spot.', 'Jade pense que tout le quartier veut le meme banc du parc parce qu elle aime cet endroit.'],
  ['Ari assumes his sister wants the same podcast topic because he is interested in it.', 'Ari suppose que sa soeur veut le meme sujet de podcast parce qu il s y intéresse.'],
  ['Maya says the class should enjoy a strict schedule because she feels calmer with one.', 'Maya dit que la classe devrait apprécier un horaire strict parce qu elle se sent plus calme avec un cadre.'],
  ['Ben thinks every driver wants the same route because he likes the scenic road.', 'Ben pense que chaque conducteur veut le meme itinéraire parce qu il aime la route panoramique.'],
  ['Priya assumes the client wants very detailed reports because she likes lots of numbers.', 'Priya suppose que le client veut des rapports tres détaillés parce qu elle aime beaucoup de chiffres.'],
  ['Omar says the whole family wants spicy food because he can handle heat.', 'Omar dit que toute la famille veut des plats épicés parce qu il supporte bien le piquant.'],
  ['Nora thinks her friend wants a surprise party because she enjoys surprises.', 'Nora pense que son amie veut une fete surprise parce qu elle aime les surprises.'],
  ['Cole assumes everyone wants the same slow pace because he dislikes being rushed.', 'Cole suppose que tout le monde veut le meme rythme lent parce qu il n aime pas qu on le presse.'],
  ['Riley says the whole office wants fewer messages because he hates chat notifications.', 'Riley dit que tout le bureau veut moins de messages parce qu il déteste les notifications de discussion.'],
  ['Pia thinks her cousin wants the same blue color because blue is her favorite.', 'Pia pense que son cousin veut la meme couleur bleue parce que le bleu est sa couleur préférée.'],
  ['Hugo says the team should use his preferred note app because he trusts it instantly.', 'Hugo dit que l équipe devrait utiliser son application de notes préférée parce qu il lui fait confiance immédiatement.'],
  ['Sam assumes the whole class wants the same small lunch because he is not very hungry.', 'Sam suppose que toute la classe veut le meme petit déjeuner parce qu il n a pas tres faim.'],
  ['Mina says her friend must want early mornings because she feels productive at dawn.', 'Mina dit que son amie doit vouloir les matins tres tôt parce qu elle se sent productive à l aube.'],
  ['Theo thinks everyone prefers the first suggestion because he already likes it.', 'Theo pense que tout le monde préfère la première suggestion parce qu il l aime déjà.'],
  ['Juno assumes the event should be quiet because loud rooms drain her.', 'Juno suppose que l événement devrait etre calme parce que les pièces bruyantes l épuisent.'],
  ['Iris says the whole family wants the same board game because she never gets tired of it.', 'Iris dit que toute la famille veut le meme jeu de société parce qu elle ne s en lasse jamais.'],
  ['Grant assumes the client wants a quick call because he likes getting answers fast.', 'Grant suppose que le client veut un appel rapide parce qu il aime recevoir des réponses vite.'],
  ['Tia says her friend will want the same dessert because she always chooses the richest option.', 'Tia dit que son amie voudra le meme dessert parce qu elle choisit toujours l option la plus riche.'],
  ['Noah assumes the group wants the same window seats because he likes looking outside.', 'Noah suppose que le groupe veut les memes places près de la fenêtre parce qu il aime regarder dehors.'],
  ['Maya says the whole office wants the same long lunch because she dislikes rushing meals.', 'Maya dit que tout le bureau veut le meme long déjeuner parce qu elle n aime pas se presser pour manger.'],
];
