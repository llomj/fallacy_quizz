...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ...
  ['Mia sees more hats on cold days and says hats bring the cold weather.', 'Mia voit plus de chapeaux les jours froids et dit que les chapeaux apportent le froid.'],
  ['Leo notices more umbrellas when the forecast is bad and says umbrellas cause storms.', 'Leo remarque plus de parapluies quand les previsions sont mauvaises et dit que les parapluies causent les tempetes.'],
  ['Nina sees more ice cream sales on hot afternoons and says ice cream makes the heat rise.', 'Nina voit plus de ventes de glace les apres-midis chauds et dit que la glace fait monter la chaleur.'],
  ['Omar sees more coffee cups in meetings that run late and says cups create long meetings.', 'Omar voit plus de tasses de cafe dans les reunions qui durent tard et dit que les tasses creent les longues reunions.'],
  ['Priya sees more people smiling near the bakery and says the bakery causes smiles by magic.', 'Priya voit plus de gens sourire pres de la boulangerie et dit que la boulangerie cree les sourires par magie.'],
  ['Ben sees traffic after a mall opens and says the mall alone caused every jam.', 'Ben voit du trafic apres l ouverture d un centre commercial et dit que le centre commercial a lui seul a cause chaque bouchon.'],
  ['Ava sees students study more after buying planners and says planners create intelligence.', 'Ava voit les etudiants etudier davantage apres avoir achete des agendas et dit que les agendas creent l intelligence.'],
  ['Theo notices more jackets when winter arrives and says jackets make winter happen.', 'Theo remarque plus de vestes quand l hiver arrive et dit que les vestes font arriver l hiver.'],
  ['Rina sees more songs played after a party starts and says songs cause parties.', 'Rina voit plus de chansons jouees apres le debut d une fete et dit que les chansons causent les fetes.'],
  ['Maya sees more buses on rainy mornings and says buses make rain.', 'Maya voit plus de bus les matins de pluie et dit que les bus font pleuvoir.'],
  ['Jules sees more library visits before exams and says libraries create exams.', 'Jules voit plus de visites a la bibliotheque avant les examens et dit que les bibliotheques creent les examens.'],
  ['Kai sees more hats at a parade and says hats cause parades.', 'Kai voit plus de chapeaux pendant un defile et dit que les chapeaux causent les defiles.'],
  ['Tara sees more tea sales when it is cold and says tea controls the thermometer.', 'Tara voit plus de ventes de the quand il fait froid et dit que le the controle le thermometre.'],
  ['Owen sees more laptops in class on project day and says laptops cause projects.', 'Owen voit plus d ordinateurs portables en classe le jour des projets et dit que les ordinateurs portables causent les projets.'],
  ['Eli sees more dogs at the park after school and says dogs create after-school hours.', 'Eli voit plus de chiens au parc apres l ecole et dit que les chiens creent les heures apres l ecole.'],
  ['Lina sees more umbrellas when weather alerts mention storms and says alerts are caused by umbrellas.', 'Lina voit plus de parapluies quand les alertes meteo mentionnent des orages et dit que les alertes sont causees par les parapluies.'],
  ['Noah sees more coffee sales during busy mornings and says coffee causes being busy.', 'Noah voit plus de ventes de cafe pendant les matins charges et dit que le cafe cause l activite.'],
  ['Zoe sees more phone cases after new phones launch and says cases cause new phones.', 'Zoe voit plus de coques de telephone apres la sortie de nouveaux telephones et dit que les coques causent les nouveaux telephones.'],
  ['Sam sees more applause after jokes and says applause causes jokes to be funny.', 'Sam voit plus d applaudissements apres les blagues et dit que les applaudissements rendent les blagues droles.'],
  ['Milo sees more coats in winter and says coats bring winter.', 'Milo voit plus de manteaux en hiver et dit que les manteaux apportent l hiver.'],
  ['Iris sees more homework on school nights and says homework causes schools to open.', 'Iris voit plus de devoirs les soirs d ecole et dit que les devoirs font ouvrir les ecoles.'],
  ['Grant sees more rain boots after forecasts and says boots make forecasts wet.', 'Grant voit plus de bottes de pluie apres les previsions et dit que les bottes mouillent les previsions.'],
  ['Pia sees more salads at lunch and says salads make lunch healthy.', 'Pia voit plus de salades au dejeuner et dit que les salades rendent le dejeuner sain.'],
  ['Dylan sees more candles at birthday parties and says candles cause birthdays.', 'Dylan voit plus de bougies lors des anniversaires et dit que les bougies causent les anniversaires.'],
  ['Hugo sees more umbrellas on the bus during storms and says umbrellas create bus rides.', 'Hugo voit plus de parapluies dans le bus pendant les orages et dit que les parapluies creent les trajets en bus.'],
  ['Mina sees more speakers at concerts and says speakers cause concerts.', 'Mina voit plus de haut-parleurs aux concerts et dit que les haut-parleurs causent les concerts.'],
  ['Leo sees more blankets on cold nights and says blankets make the night cold.', 'Leo voit plus de couvertures les nuits froides et dit que les couvertures rendent la nuit froide.'],
  ['Ari sees more sunscreen at the beach and says sunscreen causes sun.', 'Ari voit plus de creme solaire a la plage et dit que la creme solaire cause le soleil.'],
  ['Maya sees more stars on clear nights and says stars make the sky clear.', 'Maya voit plus d étoiles les nuits claires et dit que les étoiles rendent le ciel clair.'],
  ['Theo notices more umbrellas at school after weather alerts and says umbrellas trigger alerts.', 'Theo remarque plus de parapluies à l’école après les alertes météo et dit que les parapluies déclenchent les alertes.']
];
