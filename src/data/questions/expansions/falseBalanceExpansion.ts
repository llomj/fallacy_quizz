...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ...
  ['Maya said a clinical trial and a blog post about vitamins deserved equal trust on health.', "Maya a dit qu'un essai clinique et un billet de blog sur les vitamines meritaient une confiance egale sur la sante."],
  ['Leo treated a fire code booklet and a neighbor’s guess as equal sources on building safety.', "Leo a traite un livret de code incendie et une supposition de voisin comme des sources egales sur la securite du batiment."],
  ['Priya said a court filing and a comment from a lunch line had the same value about the case.', "Priya a dit qu'un acte de tribunal et un commentaire de file de dejeuner avaient la meme valeur sur l'affaire."],
  ['Noah gave a tax notice and a rumor from a group chat identical credibility.', "Noah a donne a un avis fiscal et a une rumeur de groupe la meme credibilite."],
  ['Ava said a weather bulletin and a random joke were equally good evidence for tomorrow’s rain.', "Ava a dit qu'un bulletin meteo et une blague au hasard etaient des preuves egalement bonnes pour la pluie de demain."],
  ['Theo treated a chemistry teacher and a social media myth as equally informed about acids.', "Theo a traite une professeure de chimie et un mythe des reseaux sociaux comme egalement informes sur les acides."],
  ['Rina said a hospital policy and a wellness influencer tip were equally safe advice.', "Rina a dit qu'une politique hospitaliere et un conseil d'influenceur bien-etre etaient des conseils egalement surs."],
  ['Omar gave a museum label and a tourist guess the same authority on history.', "Omar a donne a une etiquette de musee et a une supposition de touriste la meme autorite sur l'histoire."],
  ['Jules said a pilot manual and a livestream hunch were equally useful for flight safety.', "Jules a dit qu'un manuel de pilote et une intuition de diffusion en direct etaient egalement utiles pour la securite des vols."],
  ['Mina treated a city budget audit and a viral post as the same quality of evidence.', "Mina a traite un audit du budget municipal et une publication virale comme des preuves de meme qualite."],
  ['Ben said a food inspection report and a snack-ranking meme should count the same.', "Ben a dit qu'un rapport d'inspection alimentaire et un mème de classement de snack devaient compter pareil."],
  ['Nina gave a lab technician and a horoscope column equal say about medicine.', "Nina a donne a une technicienne de laboratoire et a une colonne d'horoscope le meme poids sur la medecine."],
  ['Kai said a bridge-engineering chart and a café rumor were both enough to judge the bridge.', "Kai a dit qu'un graphique d'ingénierie de pont et une rumeur de café suffisaient tous les deux pour juger le pont."],
  ['Sofia treated a school handbook and a hallway whisper as equally authoritative on attendance.', "Sofia a traite un guide scolaire et un murmure de couloir comme egalement autoritaires sur l'assiduite."],
  ['Eli said a professional translator and an auto-caption glitch were equally reliable for meaning.', "Eli a dit qu'une traductrice professionnelle et un sous-titre automatique defectueux etaient egalement fiables pour le sens."],
  ['Grant put a fire marshal and a forum rumor on the same level for evacuation advice.', "Grant a mis un officier de prevention incendie et une rumeur de forum sur le meme niveau pour les conseils d'evacuation."],
  ['Clara said a recipe tested three times and a single complaint had equal importance.', "Clara a dit qu'une recette testee trois fois et une seule plainte avaient une importance egale."],
  ['Tara treated a court transcript and a screenshot of a comment thread as the same kind of proof.', "Tara a traite une transcription de tribunal et une capture d'ecran d'un fil de commentaires comme le meme type de preuve."],
  ['Dylan said a climate report and a random comment under a video were equally solid on warming.', "Dylan a dit qu'un rapport climatique et un commentaire au hasard sous une video etaient egalement solides sur le rechauffement."],
  ['Maya gave a surgeon and a rumor blogger the same credibility about surgery risks.', "Maya a donne a une chirurgienne et a un blogueur de rumeurs la meme credibilite sur les risques chirurgicaux."],
  ['Pia said a police report and a gossip post were equally strong proof of what happened.', "Pia a dit qu'un rapport de police et un message de ragots etaient des preuves egalement solides de ce qui s'etait passe."],
  ['Hugo treated a tax form and a napkin calculation as matching evidence.', "Hugo a traite un formulaire fiscal et un calcul sur serviette comme des preuves equivalentes."],
  ['Jade said a physics demo and a random hunch should share the same conclusion.', "Jade a dit qu'une demonstration de physique et une intuition au hasard devaient mener a la meme conclusion."],
  ['Ari gave a train timetable and a car-ride rumor equal confidence about arrival times.', "Ari a donne au tableau horaire d'un train et a une rumeur de trajet en voiture la meme confiance sur les heures d'arrivee."],
  ['Rosa said a shopping receipt and a fortune-teller’s guess had identical authority on spending.', "Rosa a dit qu'un ticket de caisse et une supposition de voyante avaient une autorite identique sur les depenses."],
  ['Evan treated a science textbook and a meme thread as equally trustworthy for biology.', "Evan a traite un manuel de sciences et un fil de mèmes comme egalement dignes de confiance pour la biologie."],
  ['Lea said a safety inspection and a random "feels fine" comment should carry the same weight.', "Lea a dit qu'une inspection de securite et un commentaire au hasard du type « ca va » devaient avoir le meme poids."],
  ['Nora put a road engineer and a passenger’s guess on the same level for bridge design.', "Nora a mis une ingenieure des routes et la supposition d'un passager sur le meme plan pour le design du pont."],
  ['Sam said a hospital protocol and a social media tip were equally good advice for symptoms.', "Sam a dit qu'un protocole hospitalier et un conseil des reseaux sociaux etaient egalement bons pour les symptomes."],
  ['Lina treated a census table and a bar debate as matching evidence about population trends.', "Lina a traite un tableau de recensement et un debat de bar comme des preuves correspondantes sur les tendances demographiques."]
];
