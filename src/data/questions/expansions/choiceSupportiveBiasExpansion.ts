...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ["After buying a loud blender, Sam keeps talking about the smoothie speed and ignores the noise and cleanup.", "Apres avoir achete un blender bruyant, Sam ne parle que de la vitesse pour les smoothies et ignore le bruit et le nettoyage."],
  ["Nina picks the expensive gym membership and then focuses only on the free towels and smoothies.", "Nina choisit l'abonnement de salle de sport cher puis ne retient que les serviettes et les smoothies gratuits."],
