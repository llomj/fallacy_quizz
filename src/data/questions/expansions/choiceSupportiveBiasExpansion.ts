...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ...
  ,
  ["Mila says the pricey bike was obviously worth it because she feels cool riding it to work.", "Mila dit que le velo cher valait evidemment le coup parce qu'elle se sent classe en allant au travail avec."],
  ["Owen says the loud projector was a great pick because the image is so bright in the living room.", "Owen dit que le projecteur bruyant etait un excellent choix parce que l'image est si lumineuse dans le salon."],
  ["Priya says the fancy blender was the right decision because the first smoothie tasted amazing.", "Priya dit que le blender chic etait la bonne decision parce que le premier smoothie etait delicieux."],
  ["Noah says the tiny apartment was perfect because he likes how cozy it feels now.", "Noah dit que le minuscule appartement etait parfait parce qu'il aime maintenant son cote douillet."],
  ["Zoe says the expensive watch was smart to buy because it makes her outfit look complete.", "Zoe dit que la montre couteuse etait un achat intelligent parce qu'elle donne un air termine a sa tenue."],
  ["Theo says the awkward chair was a bargain because he is getting used to the shape.", "Theo dit que la chaise inconfortable etait une bonne affaire parce qu'il s'habitue a sa forme."],
  ["Maya says the new mattress was obviously right because she slept better once.", "Maya dit que le nouveau matelas etait evidemment le bon choix parce qu'elle a mieux dormi une fois."],
  ["Ben says the overpriced headphones were worth it because the packaging felt premium.", "Ben dit que les ecouteurs hors de prix valaient le coup parce que l'emballage faisait haut de gamme."],
  ["Aria says the messy desk organizer was a smart buy because it looks cute from far away.", "Aria dit que l'organisateur de bureau mal fait etait un achat intelligent parce qu'il est mignon de loin."],
  ["Kai says the expensive coffee subscription was worth it because he enjoyed one especially good roast.", "Kai dit que l'abonnement cafe couteux valait le coup parce qu'il a aime un cafe particulierement bon."],
  ["Rina says the giant couch was the right choice because it makes movie nights feel special.", "Rina dit que l'immense canape etait le bon choix parce qu'il rend les soirees film speciales."],
  ["Finn says the new jacket was perfect because it got him compliments the first time he wore it.", "Finn dit que la nouvelle veste etait parfaite parce qu'on l'a complimente la premiere fois qu'il l'a portee."],
  ["Lina says the weird lamp was a great purchase because it matches her personality.", "Lina dit que la lampe bizarre etait un excellent achat parce qu'elle correspond a sa personnalite."],
  ["Mina says the expensive desk chair was worth it because sitting feels less annoying now.", "Mina dit que le fauteuil de bureau couteux valait le coup parce que s'asseoir est moins penible maintenant."],
  ["Omar says the high-end mixer was a smart choice because his first cake turned out well.", "Omar dit que le robot haut de gamme etait un choix intelligent parce que son premier gateau a bien reussi."],
  ["Jade says the big houseplant was worth it because it makes the room look alive.", "Jade dit que la grande plante verte valait le coup parce qu'elle donne vie a la piece."],
  ["Eli says the expensive hiking boots were the right pick because the trail looked good in them.", "Eli dit que les bottes de randonnee chères etaient le bon choix parce que le sentier avait belle allure avec elles."],
  ["Tara says the fancy planner was a genius choice because she already wrote three goals in it.", "Tara dit que l'agenda chic etait un choix genial parce qu'elle y a deja ecrit trois objectifs."],
  ["Milo says the too-small backpack was fine because he likes packing light anyway.", "Milo dit que le sac a dos trop petit allait tres bien parce qu'il aime de toute facon voyager leger."],
  ["Nora says the noisy fan was a clever buy because it still cools the room.", "Nora dit que le ventilateur bruyant etait un achat malin parce qu'il rafraichit quand meme la piece."],
  ["Ava says the expensive lipstick was worth it because the color looked amazing once.", "Ava dit que le rouge a levres cher valait le coup parce que la couleur etait magnifique une fois."],
  ["Leo says the complicated camera was a smart choice because one photo came out great.", "Leo dit que l'appareil photo complique etait un choix intelligent parce qu'une photo a ete superbe."],
  ["Nia says the fragile vase was a great purchase because it looks elegant on the shelf.", "Nia dit que le vase fragile etait un excellent achat parce qu'il est elegant sur l'etagere."],
  ["Maya says the long commute is fine because the new car is comfortable once she is inside.", "Maya dit que le long trajet est acceptable parce que la nouvelle voiture est confortable une fois a l'interieur."],
  ["Theo says the giant water bottle was worth it because it looks motivating on his desk.", "Theo dit que la gourde geante valait le coup parce qu'elle est motivante sur son bureau."],
  ["Ben says the fancy coffee grinder was obviously the right call because the first cup tasted better.", "Ben dit que le moulin a cafe chic etait evidemment le bon choix parce que la premiere tasse etait meilleure."],
  ["Priya says the bright green couch was a genius decision because her friends noticed it.", "Priya dit que le canape vert vif etait une decision geniale parce que ses amis l'ont remarque."],
  ["Owen says the tiny screen phone was perfect because it is easier to hold.", "Owen dit que le telephone a petit ecran etait parfait parce qu'il est plus facile a tenir."],
  ["Zoe says the luxury pillow was worth the price because one nap felt incredible.", "Zoe dit que l'oreiller de luxe valait son prix parce qu'une sieste etait incroyable."],
  ["Kai says the difficult language course was a smart pick because he learned one useful phrase.", "Kai dit que le cours de langue difficile etait un bon choix parce qu'il a appris une phrase utile."],
  ["Rina says the new curtains were obviously the right choice because the room looks cozier.", "Rina dit que les nouveaux rideaux etaient evidemment le bon choix parce que la piece est plus cosy."],
  ["Finn says the expensive suitcase was a great buy because it rolled smoothly through the airport.", "Finn dit que la valise couteuse etait un excellent achat parce qu'elle roulait bien dans l'aeroport."],
  ["Lina says the awkward shoes were fine because they match her favorite dress.", "Lina dit que les chaussures bizarres etaient bien parce qu'elles vont avec sa robe preferee."],
  ["Mina says the premium notebook was worth it because the cover feels nice.", "Mina dit que le carnet premium valait le coup parce que la couverture est agreable."],
  ["Aria says the huge TV was a wise purchase because movies feel bigger now.", "Aria dit que la tres grande television etait un achat avise parce que les films paraissent plus grands maintenant."],
  ["Milo says the expensive chair cushion was worth it because his back hurts less for now.", "Milo dit que le coussin de chaise couteux valait le coup parce que son dos fait moins mal pour l'instant."],
  ["Jade says the ornate teapot was a smart choice because it makes tea time feel special.", "Jade dit que la theiere ornee etait un choix intelligent parce qu'elle rend l'heure du the speciale."],
  ["Noah says the complicated coffee machine was a great buy because he figured out one button.", "Noah dit que la machine a cafe compliquee etait un bon achat parce qu'il a compris un bouton."],
  ["Maya says the giant umbrella was perfect because it covers her and her bag.", "Maya dit que le parapluie geant etait parfait parce qu'il couvre elle et son sac."],
  ["Eli says the shiny toaster was worth it because breakfast feels nicer now.", "Eli dit que le grille-pain brillant valait le coup parce que le petit dejeuner parait plus agreable maintenant."],
];
