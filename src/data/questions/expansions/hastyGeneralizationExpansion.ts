...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ['Maya met one rude tourist and decided the whole city is rude.', 'Maya a rencontre un touriste impoli et a decide que toute la ville etait impolie.'],
  ['Ben had one bad burger and declared every fast-food place terrible.', 'Ben a eu un mauvais burger et a declare que tous les fast-foods etaient terribles.'],
