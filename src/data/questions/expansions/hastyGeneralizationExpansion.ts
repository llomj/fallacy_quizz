...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ...
  ['Mina met one rude barista and said every cafe is unfriendly.', 'Mina a rencontre une barista impolie et a dit que tous les cafes etaient peu accueillants.'],
  ['Jade had one cold soup and declared every soup place terrible.', 'Jade a eu une soupe froide et a declare que tous les restaurants de soupe etaient terribles.'],
  ['Kai saw one cluttered desk and concluded every office is a mess.', 'Kai a vu un bureau encombre et a conclu que tous les bureaux etaient en pagaille.'],
  ['Tara met one distracted cashier and decided all stores have bad service.', 'Tara a rencontre une caissiere distraite et a decide que tous les magasins avaient un mauvais service.'],
  ['Finn got one delayed email and said every email system is broken.', 'Finn a recu un e-mail en retard et a dit que tous les systemes de messagerie etaient casses.'],
  ['Maya tried one sticky dessert and said all desserts are too sweet.', 'Maya a essaye un dessert collant et a dit que tous les desserts etaient trop sucres.'],
  ['Noah saw one noisy neighbor and assumed apartment life is always awful.', 'Noah a vu un voisin bruyant et a suppose que la vie en appartement etait toujours horrible.'],
  ['Zoe had one rushed haircut and said every salon is incompetent.', 'Zoe a eu une coupe de cheveux baclee et a dit que tous les salons etaient incompetents.'],
  ['Eli saw one broken zipper and decided every jacket is poor quality.', 'Eli a vu une fermeture eclairee cassee et a decide que toutes les vestes etaient de mauvaise qualite.'],
  ['Aria met one impatient teacher and said every teacher is rude.', 'Aria a rencontre un professeur impatient et a dit que tous les professeurs etaient impolis.'],
  ['Ben saw one slow website and concluded all websites are unreliable.', 'Ben a vu un site web lent et a conclu que tous les sites etaient peu fiables.'],
  ['Rina met one grumpy driver and decided everyone on the road is angry.', 'Rina a rencontre un conducteur grincheux et a decide que tout le monde sur la route etait en colere.'],
  ['Omar had one dry sandwich and said all lunch food is bad.', 'Omar a eu un sandwich sec et a dit que tous les repas de midi etaient mauvais.'],
  ['Priya saw one messy shelf and decided every library is disorganized.', 'Priya a vu une etagere en desordre et a decide que toutes les bibliotheques etaient desorganisees.'],
  ['Theo met one forgetful neighbor and said every neighbor is unreliable.', 'Theo a rencontre un voisin tete en l air et a dit que tous les voisins etaient peu fiables.'],
  ['Lina had one awkward group chat and decided all group chats are pointless.', 'Lina a eu un groupe de discussion genant et a decide que tous les groupes de discussion etaient inutiles.'],
  ['Milo saw one spilled drink and concluded every cafe is messy.', 'Milo a vu une boisson renversee et a conclu que tous les cafes etaient sales.'],
  ['Nora met one impatient nurse and said every nurse is cold.', 'Nora a rencontre une infirmiere impatiente et a dit que toutes les infirmieres etaient froides.'],
  ['Leo had one burnt pancake and decided cooking is impossible.', 'Leo a eu une crepe brulee et a decide que cuisiner etait impossible.'],
  ['Ava saw one confusing chart and said all data is misleading.', 'Ava a vu un graphique confus et a dit que toutes les donnees etaient trompeuses.'],
  ['Mina met one rude landlord and claimed every landlord is awful.', 'Mina a rencontre un proprietaire impoli et a affirme que tous les proprietaires etaient affreux.'],
  ['Kai tried one bland salad and said healthy food has no flavor.', 'Kai a essaye une salade fade et a dit que la nourriture saine n avait aucune saveur.'],
  ['Zoe got one late package and said online shopping is always a scam.', 'Zoe a recu un colis en retard et a dit que les achats en ligne etaient toujours une arnaque.'],
  ['Finn met one sarcastic clerk and said every clerk is sarcastic.', 'Finn a rencontre un employe sarcastique et a dit que tous les employes etaient sarcastiques.'],
  ['Tara saw one broken elevator and concluded every building is neglected.', 'Tara a vu un ascenseur casse et a conclu que tous les immeubles etaient delaissees.'],
  ['Eli had one awkward interview and decided all interviews are terrible.', 'Eli a eu un entretien genant et a decide que tous les entretiens etaient terribles.'],
  ['Noah met one loud toddler and said all children are chaotic.', 'Noah a rencontre un tout-petit bruyant et a dit que tous les enfants etaient chaotiques.'],
  ['Jade got one slow server and assumed every cafe has bad service.', 'Jade a eu un serveur lent et a suppose que tous les cafes avaient un mauvais service.'],
  ['Rina had one embarrassing email and said professional communication is impossible.', 'Rina a envoye un courriel genant et a dit que la communication professionnelle etait impossible.'],
  ['Owen saw one messy park and concluded every park is neglected.', 'Owen a vu un parc en desordre et a conclu que tous les parcs etaient delaissees.'],
  ['Maya met one arrogant athlete and assumed all athletes are arrogant.', 'Maya a rencontre un sportif arrogant et a suppose que tous les sportifs etaient arrogants.'],
  ['Ben tried one confusing recipe and said cooking from recipes never works.', 'Ben a essaye une recette confuse et a dit que cuisiner a partir de recettes ne marchait jamais.'],
  ['Priya saw one cheap charger fail and decided every accessory brand is unreliable.', 'Priya a vu un chargeur bon marche tomber en panne et a decide que toutes les marques d accessoires etaient peu fiables.'],
  ['Theo had one bad cafe visit and said every cafe in town is overrated.', 'Theo a eu une mauvaise visite dans un cafe et a dit que tous les cafes de la ville etaient surevalues.'],
  ['Aria met one distracted teacher and decided teaching is a bad job.', "Aria a rencontre un professeur distrait et a decide que l'enseignement etait un mauvais metier."],
  ['Luka saw one rude passenger and said every train ride is miserable.', 'Luka a vu un passager impoli et a dit que tous les trajets en train etaient penibles.'],
  ['Ivy had one ruined picnic and concluded all outdoor meals are disasters.', 'Ivy a eu un pique-nique ruine et a conclu que tous les repas en plein air etaient des catastrophes.'],
  ['Marta met one slow receptionist and said every hotel front desk is terrible.', 'Marta a rencontre une receptionniste lente et a dit que tous les comptoirs d hotel etaient terribles.'],
  ['Drew saw one leaky bottle and decided all reusable bottles are bad.', 'Drew a vu une bouteille qui fuit et a decide que toutes les bouteilles reutilisables etaient mauvaises.'],
  ['Hana heard one loud podcast episode and said every podcast is annoying.', 'Hana a entendu un episode de podcast bruyant et a dit que tous les podcasts etaient agaçants.']
];
