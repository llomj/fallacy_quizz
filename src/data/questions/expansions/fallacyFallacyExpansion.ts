...
const SCENARIOS: ReadonlyArray<readonly [string, string]> = [
  ...
  ['Ben assumes the town policy is false because the speaker paused too long before answering.', "Ben suppose que la politique de la ville est fausse parce que l orateur a fait une trop longue pause avant de repondre."],
  ['Nina dismisses the app review because the reviewer misspelled the word battery.', "Nina rejette la critique de l application parce que le critique a mal orthographie le mot batterie."],
  ['Omar thinks a good argument about rent is worthless because the poster design was ugly.', "Omar pense qu un bon argument sur le loyer ne vaut rien parce que le design de l affiche etait laid."],
  ['Rosa rejects the school lunch proposal because the presenter wore mismatched socks.', "Rosa rejette la proposition de repas scolaire parce que la personne qui la presentait portait des chaussettes depareillees."],
  ['Jules says a recycling claim is false because the speaker used a shaky microphone.', "Jules dit qu une affirmation sur le recyclage est fausse parce que l orateur utilisait un micro qui tremblait."],
  ['Ava thinks the travel tip is wrong because the guide coughed during the explanation.', "Ava pense que le conseil de voyage est faux parce que le guide a tousse pendant l explication."],
  ['Eli dismisses the museum plan because the speaker had messy handwriting on notes.', "Eli rejette le projet de musee parce que l orateur avait une ecriture brouillonne sur ses notes."],
  ['Salma says the climate report is nonsense because one supporter made a rude comment online.', "Salma dit que le rapport sur le climat est n importe quoi parce qu un partisan a fait un commentaire grossier en ligne."],
  ['Hugo rejects the garden proposal because the presenter arrived sweaty after jogging.', "Hugo rejette le projet de jardin parce que la personne qui le presentait est arrivee en sueur apres avoir couru."],
  ['Lea calls the budget plan garbage because the speaker used a dramatic hand gesture.', "Lea appelle le plan budgetaire un navet parce que l orateur a fait un geste dramatique de la main."],
  ['Max says the road safety advice is invalid because the flyer had a crooked picture.', "Max dit que le conseil de securite routiere est invalide parce que le prospectus avait une image de travers."],
  ['Tia claims the training schedule is wrong because the trainer laughed at the start.', "Tia affirme que le planning de formation est faux parce que l entraineuse a ri au debut."],
  ['Paul says the volunteer signup is useless because the organizer drank coffee during the talk.', "Paul dit que l inscription des benevoles est inutile parce que l organisateur a bu du cafe pendant la presentation."],
  ['Yara rejects the city survey because the respondent answered with a typo.', "Yara rejette le sondage municipal parce que la personne a repondu avec une faute de frappe."],
  ['Dan believes the nutrition advice is false because the speaker had a squeaky chair.', "Dan croit que le conseil nutritionnel est faux parce que l orateur avait une chaise qui grinçait."],
  ['Mina says the workshop is bad because the presenter used too many bullet points.', "Mina dit que l atelier est mauvais parce que la presentatrice a utilise trop de puces."],
  ['Eric dismisses the road closure notice because the author posted it late at night.', "Eric balaie l avis de fermeture de route parce que l auteur l a publie tard la nuit."],
  ['Grace thinks the classroom rule is wrong because the teacher cleared her throat twice.', "Grace pense que la regle de classe est fausse parce que l enseignante s est raclee la gorge deux fois."],
  ['Owen rejects the charity goal because one donor made a bad joke.', "Owen rejette l objectif de la collecte parce qu un donateur a fait une mauvaise blague."],
  ['Mila says the town cleanup plan is nonsense because the speaker wore bright shoes.', "Mila dit que le plan de nettoyage de la ville est absurde parce que l orateur portait des chaussures vives."],
  ['Jin claims the study about sleep is wrong because the chart uses red bars.', "Jin affirme que l etude sur le sommeil est fausse parce que le graphique utilise des barres rouges."],
  ['Ravi says the parking rule is useless because the presenter mispronounced a street name.', "Ravi dit que la regle de stationnement est inutile parce que l orateur a mal prononce un nom de rue."],
  ['Sofia dismisses the event invitation because the email had one awkward sentence.', "Sofia rejette l invitation a l evenement parce que le courriel avait une phrase maladroite."],
  ['Ben says the food truck review is invalid because the reviewer likes spicy food.', "Ben dit que la critique du food truck est invalide parce que le critique aime la nourriture epicee."],
  ['Nora rejects the homework tip because the speaker blinked a lot.', "Nora rejette le conseil sur les devoirs parce que l orateur clignait beaucoup des yeux."],
  ['Alex says the museum hours are wrong because the flyer used a blue background.', "Alex dit que les horaires du musee sont faux parce que le prospectus utilisait un fond bleu."],
  ['Maya thinks the school survey is worthless because the organizer sent it on Monday.', "Maya pense que le sondage scolaire ne vaut rien parce que l organisateur l a envoye lundi."],
  ['Theo says the health tip is bad because the presenter held papers with both hands.', "Theo dit que le conseil sante est mauvais parce que la presentatrice tenait ses papiers avec deux mains."],
  ['Lina dismisses the transit plan because the speaker started with a joke.', "Lina rejette le plan de transport parce que l orateur a commence par une blague."],
  ['Omar says the recycling chart is false because the author typed slowly.', "Omar dit que le graphique sur le recyclage est faux parce que l auteur tapait lentement."],
  ['Priya rejects the class announcement because the poster had small text.', "Priya rejette l annonce de la classe parce que l affiche avait un petit texte."],
  ['Nina says the safety warning is fake because the speaker had a cold.', "Nina dit que l avertissement de securite est faux parce que l orateur avait un rhume."],
  ['Eli believes the study is useless because the researcher wore a wrinkled shirt.', "Eli croit que l etude ne vaut rien parce que le chercheur portait une chemise froissee."],
  ['Rosa says the volunteer roster is wrong because the meeting started five minutes late.', "Rosa dit que la liste des benevoles est fausse parce que la reunion a commence avec cinq minutes de retard."],
  ['Jules dismisses the app idea because the founder wore a loud jacket.', "Jules rejette l idee d application parce que le fondateur portait une veste voyante."]
];
