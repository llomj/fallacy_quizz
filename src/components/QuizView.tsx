              ...
              if (isActuallyCode) {
                return (
                  <div className="flex flex-col">
                    ...
                    <div className="px-6 pb-6 overflow-x-hidden flex-1">
                      <pre className="text-yellow-400 text-base md:text-lg font-['Fira_Code',_monospace] whitespace-pre-wrap leading-relaxed">
