...
export const GLOSSARY_TERMS_FR: GlossaryTerm[] = [
  { term: 'Attaque personnelle', definition: 'Attaquer la personne qui présente l\'argument plutôt que de répondre à l\'argument lui-même.', levelRange: '1-10', detailedDescription: 'Catégorie: Sophismes logiques - Échec de pertinence dans la prémisse.' },
  ...
  { term: 'Dilemme trompeur', definition: 'Présenter seulement deux options quand il en existe davantage.', levelRange: '1-10', detailedDescription: 'Catégorie: Sophismes logiques - Fausse dichotomie.' },
  ...
  { term: 'Gish Gallop', definition: 'Submerger un opposant avec autant d\'arguments que possible.', levelRange: '1-10', detailedDescription: 'Catégorie: Tactiques rhétoriques - Stratégie de débat.' },
  ...
  { term: 'Erreur de l\'historien', definition: 'Utiliser des informations qui n\'étaient pas disponibles pour juger les décisions passées.', levelRange: '1-10', detailedDescription: 'Catégorie: BIAIS cognitifs - Biais rétrospectif.' },
  ...
  { term: 'Post Hoc', definition: 'Supposer que parce qu\'un événement en a suivi un autre, le premier a causé le second.', levelRange: '1-10', detailedDescription: 'Catégorie: Sophismes logiques - Erreur de causalité.' },
  ...
  { term: 'Sophisme des coûts irrécupérables', definition: 'Continuer une action en raison des ressources déjà investies.', levelRange: '1-10', detailedDescription: 'Catégorie: BIAIS cognitifs - Erreur de prise de décision.' },
  { term: 'Fausse cause', definition: 'Présumer qu\'une relation réelle ou perçue entre les choses signifie que l\'une est la cause de l\'autre.', levelRange: '1-10', detailedDescription: 'Catégorie: Sophismes logiques - Erreur de causalité.' },
];
